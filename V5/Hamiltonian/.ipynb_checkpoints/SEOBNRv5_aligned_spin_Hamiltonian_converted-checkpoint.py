...
class SEOBNRv5_aligned_spin_Hamiltonian_quantities:
    ...
    def __init__(self) -> None:
        ...
        Qnos = (
            ...
            + (
                1.48275342024365 * self.nu * self.prstar**8 / self.r**sp.Rational(2*2+1, 2) 
                - 11.3175085791863 * self.nu * self.prstar**6 / self.r**sp.Rational(2*3+1, 2) 
                + 147.443752990146 * self.nu * self.prstar**4 / self.r**sp.Rational(2*4+1, 2)
            ) 
        ...
        Dnons = (
            ...
            * (
                ...
                - 326837426.241486 * self.r * (14700 * self.nu + 42911)
                ...
                * (
                    ...
                    - 7680 * self.nu * (315 * d5 + 890888.810272497) 
                ...
                * (
                    ...
                    - 7680 * self.nu * (315 * d5 + 405152.309729121) 
                ...
                * (
                    ...
                    + 70778880 * self.nu**2 * (315 * d5 + 2561145.80918574) 
                    - 138141470005001 * self.nu**2 
                    - 4718592 * self.nu * (40950*d5 + 86207832.4415642) 
        ...
        Anons = (
            ...
            *(
                ...
                + 28 * self.nu * ( 1920 * a6 + 733955.307463037) 
                + 2048
                * self.nu 
                * (
                    756 * self.nu 
