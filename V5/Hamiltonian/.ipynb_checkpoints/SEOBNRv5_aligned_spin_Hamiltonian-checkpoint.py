...
class SEOBNRv5_aligned_spin_Hamiltonian_quantities:
    ...
    def diff1(self) -> None:
        /"/"/"
        Computes and sets the first derivatives of the SEOBNRv5 aligned-spin Hamiltonian.
    ...
    def diff2(self) -> None:
        /"/"/"
        Computes and sets the second derivatives of the SEOBNRv5 aligned-spin Hamiltonian.
    ...
    def diff1_circ(self) -> None:
        /"/"/"
        Computes and sets the circular first derivatives of the SEOBNRv5 aligned-spin Hamiltonian.
