            ...
            * (
            ...
            / (
                ...
                * (
                    ...
                    - 4718592 * self.nu * (40950.0 * d5 + f2r(86207832.4415642))
                ...
                + (
                    -1698693120 * self.nu * (11592 * self.nu + 69847.0)
                    + 879923036160 * self.r**3
                    + 283115520 * self.r**2 * (14700 * self.nu + 42911.0)
                    + 49152
                    * self.r
                    * (
                        102574080 * self.nu**2
            ...
            * (
            ...
            / (
                ...
                * (
                    7680
                    * a6
                    * (self.r**4 + 2 * self.r**3 + 4 * self.r**2 + 8 * self.r + 16.0)
                    + 128.0
                    * self.r
                    * (
                ...
                * (
                    ...
                    + 161280 * self.r**5
                    + 480 * self.r**4 * (756 * self.nu + 1079.0)
                    + 960 * self.r**3 * (756 * self.nu + 1079.0)
                    + 1920 * self.r**2 * (588 * self.nu + 1079.0)
                    + 240
                    * self.r
                    * (-3024 * self.nu**2 - f2r(7466.27061066206) * self.nu + 17264.0)
                    + 13447680.0
                )
                * sp.log(self.r)
