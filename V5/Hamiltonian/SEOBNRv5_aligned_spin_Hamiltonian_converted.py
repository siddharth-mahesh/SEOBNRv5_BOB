        ...
        Qnos = (
            ...
            + (
                ...
                * (
                    ...
                    + self.nu**2 * (118.4 * sp.log(self.r) - sp.Rational(1796.13660498019)) 
                    + self.nu * (sp.Rational(452.542166996693) - sp.Rational(51.6952380952381) * sp.log(self.r) )
                ) / 
                self.r**4
            ) 
            + (
                sp.Rational(1.48275342024365) * self.nu * self.prstar**8 / self.r**sp.Rational(2*2+1, 2) 
                - sp.Rational(11.3175085791863) * self.nu * self.prstar**6 / self.r**sp.Rational(2*3+1, 2) 
                + sp.Rational(147.443752990146) * self.nu * self.prstar**4 / self.r**sp.Rational(2*4+1, 2)
            ) 
        ...
        Dnons = (
            ...
            * (
                ...
                * (
                    ...
                    + sp.Rational(86618264430493.3) * ( 1 - 0.496948781616935 * self.nu)**2 
                    + 188440788778196
                ) 
