...
def v5HM_BOB_generate_hamiltonian_ccode():
    m1,m2,r,phi,prstar,pphi,chi1,chi2,a6,dSO = sp.symbols('m1 m2 r phi prstar pphi chi1 chi2 a6 dSO',real = True)
    u = 1/r
    M = m1+m2
    delta = (m1-m2)/M
    nu = m1*m2/(M**2)
    ...
    return c_codegen([Hreal,xi],['*Hreal','*xi'],verbose = False, include_braces = False)