...
timespert, modespert, modelpert = generate_modes_opt(q*pert,chi1*pert,chi2*pert,Omega_0*pert,debug = True)
...
pyseobnrpert_dynamics_label = "./pyseobnrpertO14_dynamics_q"+str(q)+"_chi1_"+str(int(10*chi1))+"_chi2"+str(int(10*chi2))+".dat"
...
err_trustedpert_label = "./err_trusted_pert_q"+str(q)+"_chi1_"+str(int(10*chi1))+"_chi2"+str(int(10*chi2))+".dat"
err_trustedours_label = "./err_trusted_ours_q"+str(q)+"_chi1_"+str(int(10*chi1))+"_chi2"+str(int(10*chi2))+".dat"
