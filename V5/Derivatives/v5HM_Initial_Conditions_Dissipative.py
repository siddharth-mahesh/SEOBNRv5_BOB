...
def v5HM_unoptimized_IC_diss(prstar, params):
    ...
    M = m1 + m2
    eta = m1*m2/M/M
    Hreal , xi = H(m1,m2,r,prstar,pphi,chi1,chi2)
    dHdpr = xi*dHdprstar(m1,m2,r,prstar,pphi,chi1,chi2)/eta
    Omega = omega(m1,m2,r,prstar,pphi,chi1,chi2)/eta
    Omega_circ = omega_circ(m1,m2,r,pphi,chi1,chi2)/eta
    dLdr = -d2Hdr2(m1,m2,r,prstar,pphi,chi1,chi2)/d2Hdrdpphi(m1,m2,r,prstar,pphi,chi1,chi2)
