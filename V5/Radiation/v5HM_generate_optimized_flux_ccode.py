...
def v5HM_generate_optimized_flux_ccode():
    ...
    return c_codegen([flux],['*flux'],include_braces = False,verbose = False),c_codegen([h22],['*h22'],include_braces = False,verbose = False)
