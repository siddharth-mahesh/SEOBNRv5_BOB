...
def v5HM_unoptimized_flux(m1, m2, r, phi, prstar, pphi, chi1, chi2,Omega,Omega_circ,Hreal,verbose = False):
    M = m1+m2
    eta = m1*m2/(M**2)
    TINYDOUBLE = 1e-100
    delta = (m1 - m2)/M
