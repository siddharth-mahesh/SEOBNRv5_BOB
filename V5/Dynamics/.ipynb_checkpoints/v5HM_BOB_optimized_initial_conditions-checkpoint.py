...
from Derivatives.v5HM_BOB_optimized_dissipative_initial_conditions import v5HM_BOB_optimized_dissipitave_initial_conditions as IC_diss
def v5HM_BOB_optimized_initial_condition(M,q,S1,S2,f,a6,dSO,Deltat):
    m1 = q/(1 + q) 
    m2 = 1/(1 + q) 
    nu = m1*m2 
    chi1 = S1 
