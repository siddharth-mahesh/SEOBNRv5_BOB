...
def v5HM_unoptimized_initial_conditions(M,q,S1,S2,f):
    m1 = q/(1 + q) 
    m2 = 1/(1 + q) 
    nu = m1*m2 
    chi1 = S1 
    ...
    omega22NR = nu*(5.89352329617707670906 * nu4 
    ...
    return m1,m2,chi1,chi2,np.array([r,0.,prstar,pphi]),Omega_0,h,rstop,rISCO,Deltat,af,Mf,h22NR,omega22NR