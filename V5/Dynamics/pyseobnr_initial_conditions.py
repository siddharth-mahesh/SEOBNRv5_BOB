...
def IC_cons(u, omega, chi_1, chi_2, m_1, m_2):
...
def IC_diss(u, r, pphi, chi_1, chi_2, m_1, m_2):
...
def computeIC_opt(omega, chi_1, chi_2, m_1, m_2, **kwargs):
    ...
    res_cons = root(IC_cons, z, args=(omega, chi_1, chi_2, m_1, m_2), tol=6e-12)
    ...
    res_diss = root_scalar(
        IC_diss,
        bracket=[-3e-2, 0],
        args=(r0, pphi0, chi_1, chi_2, m_1, m_2),
        xtol=1e-12,
        rtol=1e-10,
    )
