...
from IMR.v5HM_BOB_optimized_nqc_terms import v5HM_BOB_optimized_nqc_terms
def v5HM_BOB_compute_optimized_nqc_coefficients(t_peak_strain, t_attach, h22_fine, dynamics_fine, h22NRpeak, omega22NRpeak, omegaQNM, tau):
    ...
    amps_BOB, omegas_BOB = v5HM_BOB_optimized_nqc_terms(t_attach,t_peak_strain,h22NRpeak,omega22NRpeak,omegaQNM,tau)
