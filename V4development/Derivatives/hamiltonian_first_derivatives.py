...
def v4P_compute_ham_x_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    condition_rhs = 1e-8
    greaterthan_bound = np.true_divide(1,2)*(condition_lhs-condition_rhs+np.abs(condition_lhs-condition_rhs))/(condition_lhs-condition_rhs-TINYDOUBLE)
    lesserthan_equal_bound = np.true_divide(1,2)*(condition_lhs-condition_rhs-TINYDOUBLE-np.abs(condition_lhs-condition_rhs-TINYDOUBLE))/(condition_lhs-condition_rhs-TINYDOUBLE)
    ...
    lambdahat_dot_Skerrhat_prmx = Skerrhat1*lambdahat1_prmx + Skerrhat2*lambdahat2_prmx + Skerrhat3*lambdahat3_prmx
    lambdahat_cross_Skerrhat3_prmx = -Skerrhat1*lambdahat2_prmx + Skerrhat2*lambdahat1_prmx
    lambdahat_cross_Skerrhat2_prmx = Skerrhat1*lambdahat3_prmx - Skerrhat3*lambdahat1_prmx
    lambdahat_cross_Skerrhat1_prmx = -Skerrhat2*lambdahat3_prmx + Skerrhat3*lambdahat2_prmx
    Skerrhat_dot_n_prmx = Skerrhat1*n1_prmx + Skerrhat2*n2_prmx + Skerrhat3*n3_prmx
    condition_lhs_prmx = -Skerrhat_dot_n_prmx*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmx = -condition_lhs_prmx*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmx*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmx/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmx = -condition_lhs_prmx*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmx*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmx/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmx = Skerrhat1*greaterthan_bound_prmx + lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat1_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmx*sin_0_1_deg) + lesserthan_equal_bound_prmx*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmx = Skerrhat2*greaterthan_bound_prmx + lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat2_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmx*sin_0_1_deg) + lesserthan_equal_bound_prmx*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmx = Skerrhat3*greaterthan_bound_prmx + lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat3_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmx*sin_0_1_deg) + lesserthan_equal_bound_prmx*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    logarg_prmx = u*(u*(u*(u*(Delta5l*u_prmx + u_prmx*(Delta5 + Delta5l*np.log(u))) + u_prmx*(Delta4 + u*(Delta5 + Delta5l*np.log(u)))) + u_prmx*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u))))) + u_prmx*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u)))))) + u_prmx*(Delta1 + u*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u))))))
    Deltaucalib_prmx = eta*logarg_prmx*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmx = eta*logarg_prmx*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**2*(u*(u*(u*(5*Delta5l*u_prmx + u_prmx*(5*Delta5 + 5*Delta5l*np.log(u))) + u_prmx*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u)))) + u_prmx*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))) + u_prmx*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1) + eta*u*u_prmx*(-2*Delta1 - 2*u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)
    Deltaubar_prmx = 2*a**2*u*u_prmx + 2*u_prmx/etaKminus1
    Deltaubarprime_prmx = -6*a**2*u**2*u_prmx - 4*u*u_prmx/etaKminus1
    ...
    sigmacoeffTerm3_prmx = 3*dSO*eta*u**2*u_prmx
    ...
    HsoTerm2coeff_prmx = expnu*(-Q_prmx - Q_prmx/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmx/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmx/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmx*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmx*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmx = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmx + expmu*expnu_prmx + expmu_prmx*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmx*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmx*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmx*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmx*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmx*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmx*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmx*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmx = -Hd_prmx + Hns_prmx + Hs_prmx + dSS*eta*u**3*u_prmx*(4*S1x**2 + 4*S1y**2 + 4*S1z**2 + 4*S2x**2 + 4*S2y**2 + 4*S2z**2)
...
def v4P_compute_ham_y_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmy = Skerrhat1*lambdahat1_prmy + Skerrhat2*lambdahat2_prmy + Skerrhat3*lambdahat3_prmy
    lambdahat_cross_Skerrhat3_prmy = -Skerrhat1*lambdahat2_prmy + Skerrhat2*lambdahat1_prmy
    lambdahat_cross_Skerrhat2_prmy = Skerrhat1*lambdahat3_prmy - Skerrhat3*lambdahat1_prmy
    lambdahat_cross_Skerrhat1_prmy = -Skerrhat2*lambdahat3_prmy + Skerrhat3*lambdahat2_prmy
    Skerrhat_dot_n_prmy = Skerrhat1*n1_prmy + Skerrhat2*n2_prmy + Skerrhat3*n3_prmy
    condition_lhs_prmy = -Skerrhat_dot_n_prmy*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmy = -condition_lhs_prmy*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmy*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmy/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmy = -condition_lhs_prmy*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmy*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmy/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmy = Skerrhat1*greaterthan_bound_prmy + lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat1_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmy*sin_0_1_deg) + lesserthan_equal_bound_prmy*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    ...
    logarg_prmy = u*(u*(u*(u*(Delta5l*u_prmy + u_prmy*(Delta5 + Delta5l*np.log(u))) + u_prmy*(Delta4 + u*(Delta5 + Delta5l*np.log(u)))) + u_prmy*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u))))) + u_prmy*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u)))))) + u_prmy*(Delta1 + u*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u))))))
    Deltaucalib_prmy = eta*logarg_prmy*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmy = eta*logarg_prmy*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**2*(u*(u*(u*(5*Delta5l*u_prmy + u_prmy*(5*Delta5 + 5*Delta5l*np.log(u))) + u_prmy*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u)))) + u_prmy*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))) + u_prmy*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1) + eta*u*u_prmy*(-2*Delta1 - 2*u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)
    Deltaubar_prmy = 2*a**2*u*u_prmy + 2*u_prmy/etaKminus1
    Deltaubarprime_prmy = -6*a**2*u**2*u_prmy - 4*u*u_prmy/etaKminus1
    ...
    SdotSkerrhat_prmy = S1_prmy*Skerrhat1 + S2_prmy*Skerrhat2 + S3_prmy*Skerrhat3
    ...
    HssTerm1_prmy = SdotSkerrhat*omega_prmy + SdotSkerrhat_prmy*omega
    ...
    HsoTerm2coeff_prmy = expnu*(-Q_prmy - Q_prmy/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmy/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmy/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmy*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmy*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmy = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmy + expmu*expnu_prmy + expmu_prmy*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmy*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmy*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmy*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmy*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmy*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmy*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmy*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmy = -Hd_prmy + Hns_prmy + Hs_prmy + dSS*eta*u**3*u_prmy*(4*S1x**2 + 4*S1y**2 + 4*S1z**2 + 4*S2x**2 + 4*S2y**2 + 4*S2z**2)
...
def v4P_compute_ham_z_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmz = Skerrhat1*lambdahat1_prmz + Skerrhat2*lambdahat2_prmz + Skerrhat3*lambdahat3_prmz
    lambdahat_cross_Skerrhat3_prmz = -Skerrhat1*lambdahat2_prmz + Skerrhat2*lambdahat1_prmz
    lambdahat_cross_Skerrhat2_prmz = Skerrhat1*lambdahat3_prmz - Skerrhat3*lambdahat1_prmz
    lambdahat_cross_Skerrhat1_prmz = -Skerrhat2*lambdahat3_prmz + Skerrhat3*lambdahat2_prmz
    Skerrhat_dot_n_prmz = Skerrhat1*n1_prmz + Skerrhat2*n2_prmz + Skerrhat3*n3_prmz
    condition_lhs_prmz = -Skerrhat_dot_n_prmz*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmz = -condition_lhs_prmz*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmz*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmz/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmz = -condition_lhs_prmz*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmz*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmz/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmz = Skerrhat1*greaterthan_bound_prmz + lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat1_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmz*sin_0_1_deg) + lesserthan_equal_bound_prmz*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmz = Skerrhat2*greaterthan_bound_prmz + lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat2_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmz*sin_0_1_deg) + lesserthan_equal_bound_prmz*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmz = Skerrhat3*greaterthan_bound_prmz + lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat3_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmz*sin_0_1_deg) + lesserthan_equal_bound_prmz*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    logarg_prmz = u*(u*(u*(u*(Delta5l*u_prmz + u_prmz*(Delta5 + Delta5l*np.log(u))) + u_prmz*(Delta4 + u*(Delta5 + Delta5l*np.log(u)))) + u_prmz*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u))))) + u_prmz*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u)))))) + u_prmz*(Delta1 + u*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*np.log(u))))))
    Deltaucalib_prmz = eta*logarg_prmz*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmz = eta*logarg_prmz*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**2*(u*(u*(u*(5*Delta5l*u_prmz + u_prmz*(5*Delta5 + 5*Delta5l*np.log(u))) + u_prmz*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u)))) + u_prmz*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))) + u_prmz*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1) + eta*u*u_prmz*(-2*Delta1 - 2*u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)
    Deltaubar_prmz = 2*a**2*u*u_prmz + 2*u_prmz/etaKminus1
    Deltaubarprime_prmz = -6*a**2*u**2*u_prmz - 4*u*u_prmz/etaKminus1
    ...
    SdotSkerrhat_prmz = S1_prmz*Skerrhat1 + S2_prmz*Skerrhat2 + S3_prmz*Skerrhat3
    ...
    HssTerm1_prmz = SdotSkerrhat*omega_prmz + SdotSkerrhat_prmz*omega
    ...
    HsoTerm2coeff_prmz = expnu*(-Q_prmz - Q_prmz/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmz/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmz/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmz*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmz*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmz = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmz + expmu*expnu_prmz + expmu_prmz*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmz*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmz*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmz*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmz*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmz*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmz*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmz*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmz = -Hd_prmz + Hns_prmz + Hs_prmz + dSS*eta*u**3*u_prmz*(4*S1x**2 + 4*S1y**2 + 4*S1z**2 + 4*S2x**2 + 4*S2y**2 + 4*S2z**2)
...
def v4P_compute_ham_p1_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmp1 = Skerrhat1*lambdahat1_prmp1 + Skerrhat2*lambdahat2_prmp1 + Skerrhat3*lambdahat3_prmp1
    lambdahat_cross_Skerrhat3_prmp1 = -Skerrhat1*lambdahat2_prmp1 + Skerrhat2*lambdahat1_prmp1
    lambdahat_cross_Skerrhat2_prmp1 = Skerrhat1*lambdahat3_prmp1 - Skerrhat3*lambdahat1_prmp1
    lambdahat_cross_Skerrhat1_prmp1 = -Skerrhat2*lambdahat3_prmp1 + Skerrhat3*lambdahat2_prmp1
    e31_prmp1 = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmp1*(1 - cos_0_1_deg) + lambdahat1_prmp1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmp1*sin_0_1_deg)
    e32_prmp1 = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmp1*(1 - cos_0_1_deg) + lambdahat2_prmp1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmp1*sin_0_1_deg)
    e33_prmp1 = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmp1*(1 - cos_0_1_deg) + lambdahat3_prmp1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmp1*sin_0_1_deg)
    ...
    Lambt_prmp1 = Deltat*a**2*sin2theta_prmp1*np.sign(Deltat*a**2*sin2theta - w2**2)
    prT_prmp1 = csi2*n1
    phat3_prmp1 = n3*prT_prmp1*(-1 + 1/csi1)
    phat2_prmp1 = n2*prT_prmp1*(-1 + 1/csi1)
    phat1_prmp1 = n1*prT_prmp1*(-1 + 1/csi1) + 1
    ...
    DrSipn2_prmp1 = 2*Deltar*pdotn*pdotn_prmp1/Sigma - Deltar*Sigma_prmp1*pdotn**2/Sigma**2
    ...
    exp2nu_prmp1 = Deltat*Sigma_prmp1/Lambt - Deltat*Lambt_prmp1*Sigma/Lambt**2
    expnu_prmp1 = exp2nu_prmp1/(2*np.sqrt(exp2nu))
    omega_prmp1 = -Lambt_prmp1*omegatilde/Lambt**2
    Lambtprime_prmp1 = -Deltatprime*a**2*sin2theta_prmp1
    mucostheta_prmp1 = a**2*costheta_prmp1/Sigma - Sigma_prmp1*a**2*costheta/Sigma**2
    nucostheta_prmp1 = a**2*costheta_prmp1*w2*(-Deltat + w2)/(Lambt*Sigma) - Sigma_prmp1*a**2*costheta*w2*(-Deltat + w2)/(Lambt*Sigma**2) - Lambt_prmp1*a**2*costheta*w2*(-Deltat + w2)/(Lambt**2*Sigma)
    omegacostheta_prmp1 = -2*Deltat*a**2*costheta_prmp1*omegatilde/Lambt**2 + 4*Deltat*Lambt_prmp1*a**2*costheta*omegatilde/Lambt**3
    mur_prmp1 = -Sigma_prmp1*r/Sigma**2
    nur_prmp1 = -Sigma_prmp1*r/Sigma**2 - Lambt_prmp1*w2*(-4*Deltat*r + Deltatprime*w2)/(2*Deltat*Lambt**2)
    ...
    sigmacoeffTerm2_prmp1 = eta*(eta*r*(-882*DrSipn2_prmp1 + 204*Qminus1_prmp1 + r*(1620*DrSipn2*DrSipn2_prmp1 - 234*DrSipn2*Qminus1_prmp1 - 234*DrSipn2_prmp1*Qminus1)) + r*(-96*DrSipn2_prmp1 - 436*Qminus1_prmp1 + r*(36*DrSipn2*Qminus1_prmp1 + 36*DrSipn2_prmp1*Qminus1 - 90*Qminus1*Qminus1_prmp1)))/(144*r**2)
    sigmacoeffTerm1_prmp1 = eta*(-3*DrSipn2_prmp1 + Qminus1_prmp1/4)
    sigmacoeff_prmp1 = sigmacoeffTerm1_prmp1 + sigmacoeffTerm2_prmp1
    ...
    SdotSkerrhat_prmp1 = S1_prmp1*Skerrhat1 + S2_prmp1*Skerrhat2 + S3_prmp1*Skerrhat3
    ...
    HssTerm1_prmp1 = SdotSkerrhat*omega_prmp1 + SdotSkerrhat_prmp1*omega
    ...
    HsoTerm2coeff_prmp1 = expnu*(-Q_prmp1 - Q_prmp1/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmp1/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmp1/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmp1*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmp1 = SdotSkerrhat*exp2nu*pdotxir*(expmu*expnu_prmp1 + expmu_prmp1*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmp1*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmp1*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmp1*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmp1*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmp1*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmp1*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq)
    ...
    Heff_prmp1 = -Hd_prmp1 + Hns_prmp1 + Hs_prmp1
...
def v4P_compute_ham_p2_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmp2 = Skerrhat1*lambdahat1_prmp2 + Skerrhat2*lambdahat2_prmp2 + Skerrhat3*lambdahat3_prmp2
    lambdahat_cross_Skerrhat3_prmp2 = -Skerrhat1*lambdahat2_prmp2 + Skerrhat2*lambdahat1_prmp2
    lambdahat_cross_Skerrhat2_prmp2 = Skerrhat1*lambdahat3_prmp2 - Skerrhat3*lambdahat1_prmp2
    lambdahat_cross_Skerrhat1_prmp2 = -Skerrhat2*lambdahat3_prmp2 + Skerrhat3*lambdahat2_prmp2
    e31_prmp2 = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmp2*(1 - cos_0_1_deg) + lambdahat1_prmp2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmp2*sin_0_1_deg)
    e32_prmp2 = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmp2*(1 - cos_0_1_deg) + lambdahat2_prmp2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmp2*sin_0_1_deg)
    e33_prmp2 = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmp2*(1 - cos_0_1_deg) + lambdahat3_prmp2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmp2*sin_0_1_deg)
    ...
    Lambt_prmp2 = Deltat*a**2*sin2theta_prmp2*np.sign(Deltat*a**2*sin2theta - w2**2)
    prT_prmp2 = csi2*n2
    phat3_prmp2 = n3*prT_prmp2*(-1 + 1/csi1)
    phat2_prmp2 = n2*prT_prmp2*(-1 + 1/csi1) + 1
    phat1_prmp2 = n1*prT_prmp2*(-1 + 1/csi1)
    ...
    DrSipn2_prmp2 = 2*Deltar*pdotn*pdotn_prmp2/Sigma - Deltar*Sigma_prmp2*pdotn**2/Sigma**2
    ...
    exp2nu_prmp2 = Deltat*Sigma_prmp2/Lambt - Deltat*Lambt_prmp2*Sigma/Lambt**2
    expnu_prmp2 = exp2nu_prmp2/(2*np.sqrt(exp2nu))
    omega_prmp2 = -Lambt_prmp2*omegatilde/Lambt**2
    Lambtprime_prmp2 = -Deltatprime*a**2*sin2theta_prmp2
    mucostheta_prmp2 = a**2*costheta_prmp2/Sigma - Sigma_prmp2*a**2*costheta/Sigma**2
    nucostheta_prmp2 = a**2*costheta_prmp2*w2*(-Deltat + w2)/(Lambt*Sigma) - Sigma_prmp2*a**2*costheta*w2*(-Deltat + w2)/(Lambt*Sigma**2) - Lambt_prmp2*a**2*costheta*w2*(-Deltat + w2)/(Lambt**2*Sigma)
    omegacostheta_prmp2 = -2*Deltat*a**2*costheta_prmp2*omegatilde/Lambt**2 + 4*Deltat*Lambt_prmp2*a**2*costheta*omegatilde/Lambt**3
    mur_prmp2 = -Sigma_prmp2*r/Sigma**2
    nur_prmp2 = -Sigma_prmp2*r/Sigma**2 - Lambt_prmp2*w2*(-4*Deltat*r + Deltatprime*w2)/(2*Deltat*Lambt**2)
    ...
    sigmacoeff_prmp2 = sigmacoeffTerm1_prmp2 + sigmacoeffTerm2_prmp2
    ...
    gammappsum_prmp2 = 2*Deltar*pdotn*pdotn_prmp2/Sigma - Deltar*Sigma_prmp2*pdotn**2/Sigma**2 - pdotvr**2*sin2theta_prmp2/(Sigma*sin2theta**2) + 2*pdotvr*pdotvr_prmp2/(Sigma*sin2theta) - Sigma_prmp2*pdotvr**2/(Sigma**2*sin2theta) - Sigma*pdotxir**2*sin2theta_prmp2/(Lambt*sin2theta**2) + 2*Sigma*pdotxir*pdotxir_prmp2/(Lambt*sin2theta) + Sigma_prmp2*pdotxir**2/(Lambt*sin2theta) - Lambt_prmp2*Sigma*pdotxir**2/(Lambt**2*sin2theta)
    Hnsradicand_prmp2 = Q4_prmp2 + gammappsum_prmp2
    alpha_prmp2 = Lambt*np.sqrt(Deltat*Sigma/Lambt)*(Deltat*Sigma_prmp2/(2*Lambt) - Deltat*Lambt_prmp2*Sigma/(2*Lambt**2))/(Deltat*Sigma)
    ...
    HsoTerm2coeff_prmp2 = expnu*(-Q_prmp2 - Q_prmp2/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmp2/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmp2/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmp2*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmp2 = SdotSkerrhat*exp2nu*pdotxir*(expmu*expnu_prmp2 + expmu_prmp2*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmp2*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmp2*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmp2*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmp2*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmp2*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmp2*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq)
    ...
    Heff_prmp2 = -Hd_prmp2 + Hns_prmp2 + Hs_prmp2
...
def v4P_compute_ham_p3_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmp3 = Skerrhat1*lambdahat1_prmp3 + Skerrhat2*lambdahat2_prmp3 + Skerrhat3*lambdahat3_prmp3
    lambdahat_cross_Skerrhat3_prmp3 = -Skerrhat1*lambdahat2_prmp3 + Skerrhat2*lambdahat1_prmp3
    lambdahat_cross_Skerrhat2_prmp3 = Skerrhat1*lambdahat3_prmp3 - Skerrhat3*lambdahat1_prmp3
    lambdahat_cross_Skerrhat1_prmp3 = -Skerrhat2*lambdahat3_prmp3 + Skerrhat3*lambdahat2_prmp3
    e31_prmp3 = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmp3*(1 - cos_0_1_deg) + lambdahat1_prmp3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmp3*sin_0_1_deg)
    e32_prmp3 = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmp3*(1 - cos_0_1_deg) + lambdahat2_prmp3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmp3*sin_0_1_deg)
    e33_prmp3 = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmp3*(1 - cos_0_1_deg) + lambdahat3_prmp3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmp3*sin_0_1_deg)
    ...
    Lambt_prmp3 = Deltat*a**2*sin2theta_prmp3*np.sign(Deltat*a**2*sin2theta - w2**2)
    prT_prmp3 = csi2*n3
    phat3_prmp3 = n3*prT_prmp3*(-1 + 1/csi1) + 1
    phat2_prmp3 = n2*prT_prmp3*(-1 + 1/csi1)
    phat1_prmp3 = n1*prT_prmp3*(-1 + 1/csi1)
    ...
    DrSipn2_prmp3 = 2*Deltar*pdotn*pdotn_prmp3/Sigma - Deltar*Sigma_prmp3*pdotn**2/Sigma**2
    ...
    exp2nu_prmp3 = Deltat*Sigma_prmp3/Lambt - Deltat*Lambt_prmp3*Sigma/Lambt**2
    expnu_prmp3 = exp2nu_prmp3/(2*np.sqrt(exp2nu))
    omega_prmp3 = -Lambt_prmp3*omegatilde/Lambt**2
    Lambtprime_prmp3 = -Deltatprime*a**2*sin2theta_prmp3
    mucostheta_prmp3 = a**2*costheta_prmp3/Sigma - Sigma_prmp3*a**2*costheta/Sigma**2
    nucostheta_prmp3 = a**2*costheta_prmp3*w2*(-Deltat + w2)/(Lambt*Sigma) - Sigma_prmp3*a**2*costheta*w2*(-Deltat + w2)/(Lambt*Sigma**2) - Lambt_prmp3*a**2*costheta*w2*(-Deltat + w2)/(Lambt**2*Sigma)
    omegacostheta_prmp3 = -2*Deltat*a**2*costheta_prmp3*omegatilde/Lambt**2 + 4*Deltat*Lambt_prmp3*a**2*costheta*omegatilde/Lambt**3
    mur_prmp3 = -Sigma_prmp3*r/Sigma**2
    nur_prmp3 = -Sigma_prmp3*r/Sigma**2 - Lambt_prmp3*w2*(-4*Deltat*r + Deltatprime*w2)/(2*Deltat*Lambt**2)
    ...
    sigmacoeff_prmp3 = sigmacoeffTerm1_prmp3 + sigmacoeffTerm2_prmp3
    ...
    gammappsum_prmp3 = 2*Deltar*pdotn*pdotn_prmp3/Sigma - Deltar*Sigma_prmp3*pdotn**2/Sigma**2 - pdotvr**2*sin2theta_prmp3/(Sigma*sin2theta**2) + 2*pdotvr*pdotvr_prmp3/(Sigma*sin2theta) - Sigma_prmp3*pdotvr**2/(Sigma**2*sin2theta) - Sigma*pdotxir**2*sin2theta_prmp3/(Lambt*sin2theta**2) + 2*Sigma*pdotxir*pdotxir_prmp3/(Lambt*sin2theta) + Sigma_prmp3*pdotxir**2/(Lambt*sin2theta) - Lambt_prmp3*Sigma*pdotxir**2/(Lambt**2*sin2theta)
    Hnsradicand_prmp3 = Q4_prmp3 + gammappsum_prmp3
    alpha_prmp3 = Lambt*np.sqrt(Deltat*Sigma/Lambt)*(Deltat*Sigma_prmp3/(2*Lambt) - Deltat*Lambt_prmp3*Sigma/(2*Lambt**2))/(Deltat*Sigma)
    ...
    HssTerm2_prmp3 = Btilde**2*xisq*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn_prmp3 - Jtilde*Sdotv_prmp3*pdotn + Sdotn*pdotvr_prmp3 + Sdotn_prmp3*pdotvr) + Jtilde*pdotn_prmp3*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(Q_prmp3 + Q_prmp3/(2*np.sqrt(Q))) + Sdotv*exp2mu_prmp3*(np.sqrt(Q) + Q) + Sdotv_prmp3*exp2mu*(np.sqrt(Q) + Q)) + Btilde**2*xisq_prmp3*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(np.sqrt(Q) + Q)) + expmu*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr_prmp3 - Btilde*Sdotxi*expnu_prmp3*pdotvr - Btilde*Sdotxi_prmp3*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir_prmp3 + Sdotv*exp2nu*expmu_prmp3*pdotxir + Sdotv*exp2nu_prmp3*expmu*pdotxir + Sdotv_prmp3*exp2nu*expmu*pdotxir) + expmu*pdotxir_prmp3*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir) + expmu_prmp3*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir)
    ...
    HsoTerm2coeff_prmp3 = expnu*(-Q_prmp3 - Q_prmp3/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmp3/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmp3/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmp3*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmp3 = SdotSkerrhat*exp2nu*pdotxir*(expmu*expnu_prmp3 + expmu_prmp3*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmp3*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmp3*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmp3*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmp3*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmp3*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmp3*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq)
    ...
    Heff_prmp3 = -Hd_prmp3 + Hns_prmp3 + Hs_prmp3
...
def v4P_compute_ham_S1x_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmS1x = Skerrhat1_prmS1x*lambdahat1 + Skerrhat2_prmS1x*lambdahat2 + Skerrhat3_prmS1x*lambdahat3
    lambdahat_cross_Skerrhat3_prmS1x = -Skerrhat1_prmS1x*lambdahat2 + Skerrhat2_prmS1x*lambdahat1
    lambdahat_cross_Skerrhat2_prmS1x = Skerrhat1_prmS1x*lambdahat3 - Skerrhat3_prmS1x*lambdahat1
    lambdahat_cross_Skerrhat1_prmS1x = -Skerrhat2_prmS1x*lambdahat3 + Skerrhat3_prmS1x*lambdahat2
    Skerrhat_dot_n_prmS1x = Skerrhat1_prmS1x*n1 + Skerrhat2_prmS1x*n2 + Skerrhat3_prmS1x*n3
    condition_lhs_prmS1x = -Skerrhat_dot_n_prmS1x*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmS1x = -condition_lhs_prmS1x*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS1x*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmS1x/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmS1x = -condition_lhs_prmS1x*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS1x*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmS1x/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmS1x = Skerrhat1*greaterthan_bound_prmS1x + Skerrhat1_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1x*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1x*sin_0_1_deg) + lesserthan_equal_bound_prmS1x*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmS1x = Skerrhat2*greaterthan_bound_prmS1x + Skerrhat2_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1x*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1x*sin_0_1_deg) + lesserthan_equal_bound_prmS1x*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmS1x = Skerrhat3*greaterthan_bound_prmS1x + Skerrhat3_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1x*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1x*sin_0_1_deg) + lesserthan_equal_bound_prmS1x*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    Delta2_prmS1x = -2*Delta0*a*a_prmS1x*etaKminus1**2
    Delta3_prmS1x = Delta1*Delta2_prmS1x - 2*Delta1*a*a_prmS1x*etaKminus1**2 - 2*Delta2_prmS1x*etaKminus1
    Delta4_prmS1x = -Delta1**2*Delta2_prmS1x + Delta1*(2*Delta2_prmS1x*etaKminus1 + Delta3_prmS1x) + Delta2*Delta2_prmS1x - Delta2_prmS1x*a**2*etaKminus1**2 - 2*Delta3_prmS1x*etaKminus1 + a*a_prmS1x*etaKminus1**2*(Delta1**2 - 2*Delta2)
    Delta5_prmS1x = etaKminus1**2*(-a**2*(-3*Delta1*Delta2_prmS1x + 3*Delta3_prmS1x)/3 + a*a_prmS1x*(-2*Delta1**3 + 6*Delta1*Delta2 - 6*Delta3)/3 + (-4*Delta1**2*Delta2_prmS1x + 4*Delta1*Delta3_prmS1x + 4*Delta2*Delta2_prmS1x - 4*Delta4_prmS1x)/(2*etaKminus1) - (-5*Delta1**3*Delta2_prmS1x + 5*Delta1**2*Delta3_prmS1x + 10*Delta1*Delta2*Delta2_prmS1x - 5*Delta1*Delta4_prmS1x - 5*Delta2*Delta3_prmS1x - 5*Delta2_prmS1x*Delta3)/(5*etaKminus1**2))
    logarg_prmS1x = u**2*(Delta2_prmS1x + u*(Delta3_prmS1x + u*(Delta4_prmS1x + Delta5_prmS1x*u)))
    Deltaucalib_prmS1x = eta*logarg_prmS1x*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmS1x = eta*logarg_prmS1x*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**3*(2*Delta2_prmS1x + u*(3*Delta3_prmS1x + u*(4*Delta4_prmS1x + 5*Delta5_prmS1x*u)))/(logarg + 1)
    Deltaubar_prmS1x = 2*a*a_prmS1x*u**2
    Deltaubarprime_prmS1x = -4*a*a_prmS1x*u**3
    ...
    sigmacoeffTerm2_prmS1x = eta*(eta*r*(-882*DrSipn2_prmS1x + 204*Qminus1_prmS1x + r*(1620*DrSipn2*DrSipn2_prmS1x - 234*DrSipn2*Qminus1_prmS1x - 234*DrSipn2_prmS1x*Qminus1)) + r*(-96*DrSipn2_prmS1x - 436*Qminus1_prmS1x + r*(36*DrSipn2*Qminus1_prmS1x + 36*DrSipn2_prmS1x*Qminus1 - 90*Qminus1*Qminus1_prmS1x)))/(144*r**2)
    sigmacoeffTerm1_prmS1x = eta*(-3*DrSipn2_prmS1x + Qminus1_prmS1x/4)
    sigmacoeff_prmS1x = sigmacoeffTerm1_prmS1x + sigmacoeffTerm2_prmS1x
    ...
    SdotSkerrhat_prmS1x = S1*Skerrhat1_prmS1x + S1_prmS1x*Skerrhat1 + S2*Skerrhat2_prmS1x + S2_prmS1x*Skerrhat2 + S3*Skerrhat3_prmS1x + S3_prmS1x*Skerrhat3
    ...
    HssTerm1_prmS1x = SdotSkerrhat*omega_prmS1x + SdotSkerrhat_prmS1x*omega
    ...
    HsoTerm2coeff_prmS1x = expnu*(-Q_prmS1x - Q_prmS1x/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmS1x/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmS1x/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmS1x*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmS1x*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmS1x = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmS1x + expmu*expnu_prmS1x + expmu_prmS1x*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmS1x*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmS1x*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmS1x*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmS1x*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmS1x*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmS1x*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmS1x*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmS1x = -Hd_prmS1x + Hns_prmS1x + Hs_prmS1x + 2*S1x*dSS*eta*u**4
...
def v4P_compute_ham_S1y_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmS1y = Skerrhat1_prmS1y*lambdahat1 + Skerrhat2_prmS1y*lambdahat2 + Skerrhat3_prmS1y*lambdahat3
    lambdahat_cross_Skerrhat3_prmS1y = -Skerrhat1_prmS1y*lambdahat2 + Skerrhat2_prmS1y*lambdahat1
    lambdahat_cross_Skerrhat2_prmS1y = Skerrhat1_prmS1y*lambdahat3 - Skerrhat3_prmS1y*lambdahat1
    lambdahat_cross_Skerrhat1_prmS1y = -Skerrhat2_prmS1y*lambdahat3 + Skerrhat3_prmS1y*lambdahat2
    Skerrhat_dot_n_prmS1y = Skerrhat1_prmS1y*n1 + Skerrhat2_prmS1y*n2 + Skerrhat3_prmS1y*n3
    condition_lhs_prmS1y = -Skerrhat_dot_n_prmS1y*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmS1y = -condition_lhs_prmS1y*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS1y*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmS1y/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmS1y = -condition_lhs_prmS1y*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS1y*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmS1y/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmS1y = Skerrhat1*greaterthan_bound_prmS1y + Skerrhat1_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1y*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1y*sin_0_1_deg) + lesserthan_equal_bound_prmS1y*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmS1y = Skerrhat2*greaterthan_bound_prmS1y + Skerrhat2_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1y*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1y*sin_0_1_deg) + lesserthan_equal_bound_prmS1y*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmS1y = Skerrhat3*greaterthan_bound_prmS1y + Skerrhat3_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1y*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1y*sin_0_1_deg) + lesserthan_equal_bound_prmS1y*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    Delta2_prmS1y = -2*Delta0*a*a_prmS1y*etaKminus1**2
    Delta3_prmS1y = Delta1*Delta2_prmS1y - 2*Delta1*a*a_prmS1y*etaKminus1**2 - 2*Delta2_prmS1y*etaKminus1
    Delta4_prmS1y = -Delta1**2*Delta2_prmS1y + Delta1*(2*Delta2_prmS1y*etaKminus1 + Delta3_prmS1y) + Delta2*Delta2_prmS1y - Delta2_prmS1y*a**2*etaKminus1**2 - 2*Delta3_prmS1y*etaKminus1 + a*a_prmS1y*etaKminus1**2*(Delta1**2 - 2*Delta2)
    Delta5_prmS1y = etaKminus1**2*(-a**2*(-3*Delta1*Delta2_prmS1y + 3*Delta3_prmS1y)/3 + a*a_prmS1y*(-2*Delta1**3 + 6*Delta1*Delta2 - 6*Delta3)/3 + (-4*Delta1**2*Delta2_prmS1y + 4*Delta1*Delta3_prmS1y + 4*Delta2*Delta2_prmS1y - 4*Delta4_prmS1y)/(2*etaKminus1) - (-5*Delta1**3*Delta2_prmS1y + 5*Delta1**2*Delta3_prmS1y + 10*Delta1*Delta2*Delta2_prmS1y - 5*Delta1*Delta4_prmS1y - 5*Delta2*Delta3_prmS1y - 5*Delta2_prmS1y*Delta3)/(5*etaKminus1**2))
    logarg_prmS1y = u**2*(Delta2_prmS1y + u*(Delta3_prmS1y + u*(Delta4_prmS1y + Delta5_prmS1y*u)))
    Deltaucalib_prmS1y = eta*logarg_prmS1y*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmS1y = eta*logarg_prmS1y*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**3*(2*Delta2_prmS1y + u*(3*Delta3_prmS1y + u*(4*Delta4_prmS1y + 5*Delta5_prmS1y*u)))/(logarg + 1)
    Deltaubar_prmS1y = 2*a*a_prmS1y*u**2
    Deltaubarprime_prmS1y = -4*a*a_prmS1y*u**3
    ...
    sigmacoeffTerm2_prmS1y = eta*(eta*r*(-882*DrSipn2_prmS1y + 204*Qminus1_prmS1y + r*(1620*DrSipn2*DrSipn2_prmS1y - 234*DrSipn2*Qminus1_prmS1y - 234*DrSipn2_prmS1y*Qminus1)) + r*(-96*DrSipn2_prmS1y - 436*Qminus1_prmS1y + r*(36*DrSipn2*Qminus1_prmS1y + 36*DrSipn2_prmS1y*Qminus1 - 90*Qminus1*Qminus1_prmS1y)))/(144*r**2)
    sigmacoeffTerm1_prmS1y = eta*(-3*DrSipn2_prmS1y + Qminus1_prmS1y/4)
    sigmacoeff_prmS1y = sigmacoeffTerm1_prmS1y + sigmacoeffTerm2_prmS1y
    ...
    SdotSkerrhat_prmS1y = S1*Skerrhat1_prmS1y + S1_prmS1y*Skerrhat1 + S2*Skerrhat2_prmS1y + S2_prmS1y*Skerrhat2 + S3*Skerrhat3_prmS1y + S3_prmS1y*Skerrhat3
    ...
    HssTerm1_prmS1y = SdotSkerrhat*omega_prmS1y + SdotSkerrhat_prmS1y*omega
    ...
    HsoTerm2coeff_prmS1y = expnu*(-Q_prmS1y - Q_prmS1y/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmS1y/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmS1y/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmS1y*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmS1y*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmS1y = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmS1y + expmu*expnu_prmS1y + expmu_prmS1y*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmS1y*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmS1y*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmS1y*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmS1y*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmS1y*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmS1y*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmS1y*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmS1y = -Hd_prmS1y + Hns_prmS1y + Hs_prmS1y + 2*S1y*dSS*eta*u**4
...
def v4P_compute_ham_S1z_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmS1z = Skerrhat1_prmS1z*lambdahat1 + Skerrhat2_prmS1z*lambdahat2 + Skerrhat3_prmS1z*lambdahat3
    lambdahat_cross_Skerrhat3_prmS1z = -Skerrhat1_prmS1z*lambdahat2 + Skerrhat2_prmS1z*lambdahat1
    lambdahat_cross_Skerrhat2_prmS1z = Skerrhat1_prmS1z*lambdahat3 - Skerrhat3_prmS1z*lambdahat1
    lambdahat_cross_Skerrhat1_prmS1z = -Skerrhat2_prmS1z*lambdahat3 + Skerrhat3_prmS1z*lambdahat2
    Skerrhat_dot_n_prmS1z = Skerrhat1_prmS1z*n1 + Skerrhat2_prmS1z*n2 + Skerrhat3_prmS1z*n3
    condition_lhs_prmS1z = -Skerrhat_dot_n_prmS1z*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmS1z = -condition_lhs_prmS1z*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS1z*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmS1z/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmS1z = -condition_lhs_prmS1z*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS1z*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmS1z/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmS1z = Skerrhat1*greaterthan_bound_prmS1z + Skerrhat1_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1z*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1z*sin_0_1_deg) + lesserthan_equal_bound_prmS1z*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmS1z = Skerrhat2*greaterthan_bound_prmS1z + Skerrhat2_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1z*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1z*sin_0_1_deg) + lesserthan_equal_bound_prmS1z*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmS1z = Skerrhat3*greaterthan_bound_prmS1z + Skerrhat3_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1z*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1z*sin_0_1_deg) + lesserthan_equal_bound_prmS1z*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    Delta2_prmS1z = -2*Delta0*a*a_prmS1z*etaKminus1**2
    Delta3_prmS1z = Delta1*Delta2_prmS1z - 2*Delta1*a*a_prmS1z*etaKminus1**2 - 2*Delta2_prmS1z*etaKminus1
    Delta4_prmS1z = -Delta1**2*Delta2_prmS1z + Delta1*(2*Delta2_prmS1z*etaKminus1 + Delta3_prmS1z) + Delta2*Delta2_prmS1z - Delta2_prmS1z*a**2*etaKminus1**2 - 2*Delta3_prmS1z*etaKminus1 + a*a_prmS1z*etaKminus1**2*(Delta1**2 - 2*Delta2)
    Delta5_prmS1z = etaKminus1**2*(-a**2*(-3*Delta1*Delta2_prmS1z + 3*Delta3_prmS1z)/3 + a*a_prmS1z*(-2*Delta1**3 + 6*Delta1*Delta2 - 6*Delta3)/3 + (-4*Delta1**2*Delta2_prmS1z + 4*Delta1*Delta3_prmS1z + 4*Delta2*Delta2_prmS1z - 4*Delta4_prmS1z)/(2*etaKminus1) - (-5*Delta1**3*Delta2_prmS1z + 5*Delta1**2*Delta3_prmS1z + 10*Delta1*Delta2*Delta2_prmS1z - 5*Delta1*Delta4_prmS1z - 5*Delta2*Delta3_prmS1z - 5*Delta2_prmS1z*Delta3)/(5*etaKminus1**2))
    logarg_prmS1z = u**2*(Delta2_prmS1z + u*(Delta3_prmS1z + u*(Delta4_prmS1z + Delta5_prmS1z*u)))
    Deltaucalib_prmS1z = eta*logarg_prmS1z*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmS1z = eta*logarg_prmS1z*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**3*(2*Delta2_prmS1z + u*(3*Delta3_prmS1z + u*(4*Delta4_prmS1z + 5*Delta5_prmS1z*u)))/(logarg + 1)
    Deltaubar_prmS1z = 2*a*a_prmS1z*u**2
    Deltaubarprime_prmS1z = -4*a*a_prmS1z*u**3
    ...
    sigmacoeffTerm2_prmS1z = eta*(eta*r*(-882*DrSipn2_prmS1z + 204*Qminus1_prmS1z + r*(1620*DrSipn2*DrSipn2_prmS1z - 234*DrSipn2*Qminus1_prmS1z - 234*DrSipn2_prmS1z*Qminus1)) + r*(-96*DrSipn2_prmS1z - 436*Qminus1_prmS1z + r*(36*DrSipn2*Qminus1_prmS1z + 36*DrSipn2_prmS1z*Qminus1 - 90*Qminus1*Qminus1_prmS1z)))/(144*r**2)
    sigmacoeffTerm1_prmS1z = eta*(-3*DrSipn2_prmS1z + Qminus1_prmS1z/4)
    sigmacoeff_prmS1z = sigmacoeffTerm1_prmS1z + sigmacoeffTerm2_prmS1z
    ...
    SdotSkerrhat_prmS1z = S1*Skerrhat1_prmS1z + S1_prmS1z*Skerrhat1 + S2*Skerrhat2_prmS1z + S2_prmS1z*Skerrhat2 + S3*Skerrhat3_prmS1z + S3_prmS1z*Skerrhat3
    ...
    HssTerm1_prmS1z = SdotSkerrhat*omega_prmS1z + SdotSkerrhat_prmS1z*omega
    ...
    HsoTerm2coeff_prmS1z = expnu*(-Q_prmS1z - Q_prmS1z/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmS1z/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmS1z/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmS1z*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmS1z*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmS1z = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmS1z + expmu*expnu_prmS1z + expmu_prmS1z*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmS1z*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmS1z*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmS1z*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmS1z*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmS1z*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmS1z*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmS1z*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmS1z = -Hd_prmS1z + Hns_prmS1z + Hs_prmS1z + 2*S1z*dSS*eta*u**4
...
def v4P_compute_ham_S2x_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmS2x = Skerrhat1_prmS2x*lambdahat1 + Skerrhat2_prmS2x*lambdahat2 + Skerrhat3_prmS2x*lambdahat3
    lambdahat_cross_Skerrhat3_prmS2x = -Skerrhat1_prmS2x*lambdahat2 + Skerrhat2_prmS2x*lambdahat1
    lambdahat_cross_Skerrhat2_prmS2x = Skerrhat1_prmS2x*lambdahat3 - Skerrhat3_prmS2x*lambdahat1
    lambdahat_cross_Skerrhat1_prmS2x = -Skerrhat2_prmS2x*lambdahat3 + Skerrhat3_prmS2x*lambdahat2
    Skerrhat_dot_n_prmS2x = Skerrhat1_prmS2x*n1 + Skerrhat2_prmS2x*n2 + Skerrhat3_prmS2x*n3
    condition_lhs_prmS2x = -Skerrhat_dot_n_prmS2x*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmS2x = -condition_lhs_prmS2x*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS2x*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmS2x/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmS2x = -condition_lhs_prmS2x*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS2x*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmS2x/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmS2x = Skerrhat1*greaterthan_bound_prmS2x + Skerrhat1_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2x*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2x*sin_0_1_deg) + lesserthan_equal_bound_prmS2x*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmS2x = Skerrhat2*greaterthan_bound_prmS2x + Skerrhat2_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2x*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2x*sin_0_1_deg) + lesserthan_equal_bound_prmS2x*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmS2x = Skerrhat3*greaterthan_bound_prmS2x + Skerrhat3_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2x*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2x*sin_0_1_deg) + lesserthan_equal_bound_prmS2x*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    Delta2_prmS2x = -2*Delta0*a*a_prmS2x*etaKminus1**2
    Delta3_prmS2x = Delta1*Delta2_prmS2x - 2*Delta1*a*a_prmS2x*etaKminus1**2 - 2*Delta2_prmS2x*etaKminus1
    Delta4_prmS2x = -Delta1**2*Delta2_prmS2x + Delta1*(2*Delta2_prmS2x*etaKminus1 + Delta3_prmS2x) + Delta2*Delta2_prmS2x - Delta2_prmS2x*a**2*etaKminus1**2 - 2*Delta3_prmS2x*etaKminus1 + a*a_prmS2x*etaKminus1**2*(Delta1**2 - 2*Delta2)
    Delta5_prmS2x = etaKminus1**2*(-a**2*(-3*Delta1*Delta2_prmS2x + 3*Delta3_prmS2x)/3 + a*a_prmS2x*(-2*Delta1**3 + 6*Delta1*Delta2 - 6*Delta3)/3 + (-4*Delta1**2*Delta2_prmS2x + 4*Delta1*Delta3_prmS2x + 4*Delta2*Delta2_prmS2x - 4*Delta4_prmS2x)/(2*etaKminus1) - (-5*Delta1**3*Delta2_prmS2x + 5*Delta1**2*Delta3_prmS2x + 10*Delta1*Delta2*Delta2_prmS2x - 5*Delta1*Delta4_prmS2x - 5*Delta2*Delta3_prmS2x - 5*Delta2_prmS2x*Delta3)/(5*etaKminus1**2))
    logarg_prmS2x = u**2*(Delta2_prmS2x + u*(Delta3_prmS2x + u*(Delta4_prmS2x + Delta5_prmS2x*u)))
    Deltaucalib_prmS2x = eta*logarg_prmS2x*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmS2x = eta*logarg_prmS2x*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**3*(2*Delta2_prmS2x + u*(3*Delta3_prmS2x + u*(4*Delta4_prmS2x + 5*Delta5_prmS2x*u)))/(logarg + 1)
    Deltaubar_prmS2x = 2*a*a_prmS2x*u**2
    Deltaubarprime_prmS2x = -4*a*a_prmS2x*u**3
    ...
    sigmacoeffTerm2_prmS2x = eta*(eta*r*(-882*DrSipn2_prmS2x + 204*Qminus1_prmS2x + r*(1620*DrSipn2*DrSipn2_prmS2x - 234*DrSipn2*Qminus1_prmS2x - 234*DrSipn2_prmS2x*Qminus1)) + r*(-96*DrSipn2_prmS2x - 436*Qminus1_prmS2x + r*(36*DrSipn2*Qminus1_prmS2x + 36*DrSipn2_prmS2x*Qminus1 - 90*Qminus1*Qminus1_prmS2x)))/(144*r**2)
    sigmacoeffTerm1_prmS2x = eta*(-3*DrSipn2_prmS2x + Qminus1_prmS2x/4)
    sigmacoeff_prmS2x = sigmacoeffTerm1_prmS2x + sigmacoeffTerm2_prmS2x
    ...
    SdotSkerrhat_prmS2x = S1*Skerrhat1_prmS2x + S1_prmS2x*Skerrhat1 + S2*Skerrhat2_prmS2x + S2_prmS2x*Skerrhat2 + S3*Skerrhat3_prmS2x + S3_prmS2x*Skerrhat3
    ...
    HssTerm1_prmS2x = SdotSkerrhat*omega_prmS2x + SdotSkerrhat_prmS2x*omega
    ...
    HsoTerm2coeff_prmS2x = expnu*(-Q_prmS2x - Q_prmS2x/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmS2x/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmS2x/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmS2x*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmS2x*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmS2x = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmS2x + expmu*expnu_prmS2x + expmu_prmS2x*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmS2x*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmS2x*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmS2x*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmS2x*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmS2x*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmS2x*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmS2x*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmS2x = -Hd_prmS2x + Hns_prmS2x + Hs_prmS2x + 2*S2x*dSS*eta*u**4
...
def v4P_compute_ham_S2y_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmS2y = Skerrhat1_prmS2y*lambdahat1 + Skerrhat2_prmS2y*lambdahat2 + Skerrhat3_prmS2y*lambdahat3
    lambdahat_cross_Skerrhat3_prmS2y = -Skerrhat1_prmS2y*lambdahat2 + Skerrhat2_prmS2y*lambdahat1
    lambdahat_cross_Skerrhat2_prmS2y = Skerrhat1_prmS2y*lambdahat3 - Skerrhat3_prmS2y*lambdahat1
    lambdahat_cross_Skerrhat1_prmS2y = -Skerrhat2_prmS2y*lambdahat3 + Skerrhat3_prmS2y*lambdahat2
    Skerrhat_dot_n_prmS2y = Skerrhat1_prmS2y*n1 + Skerrhat2_prmS2y*n2 + Skerrhat3_prmS2y*n3
    condition_lhs_prmS2y = -Skerrhat_dot_n_prmS2y*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmS2y = -condition_lhs_prmS2y*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS2y*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmS2y/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmS2y = -condition_lhs_prmS2y*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS2y*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmS2y/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmS2y = Skerrhat1*greaterthan_bound_prmS2y + Skerrhat1_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2y*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2y*sin_0_1_deg) + lesserthan_equal_bound_prmS2y*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmS2y = Skerrhat2*greaterthan_bound_prmS2y + Skerrhat2_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2y*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2y*sin_0_1_deg) + lesserthan_equal_bound_prmS2y*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmS2y = Skerrhat3*greaterthan_bound_prmS2y + Skerrhat3_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2y*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2y*sin_0_1_deg) + lesserthan_equal_bound_prmS2y*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    Delta2_prmS2y = -2*Delta0*a*a_prmS2y*etaKminus1**2
    Delta3_prmS2y = Delta1*Delta2_prmS2y - 2*Delta1*a*a_prmS2y*etaKminus1**2 - 2*Delta2_prmS2y*etaKminus1
    Delta4_prmS2y = -Delta1**2*Delta2_prmS2y + Delta1*(2*Delta2_prmS2y*etaKminus1 + Delta3_prmS2y) + Delta2*Delta2_prmS2y - Delta2_prmS2y*a**2*etaKminus1**2 - 2*Delta3_prmS2y*etaKminus1 + a*a_prmS2y*etaKminus1**2*(Delta1**2 - 2*Delta2)
    Delta5_prmS2y = etaKminus1**2*(-a**2*(-3*Delta1*Delta2_prmS2y + 3*Delta3_prmS2y)/3 + a*a_prmS2y*(-2*Delta1**3 + 6*Delta1*Delta2 - 6*Delta3)/3 + (-4*Delta1**2*Delta2_prmS2y + 4*Delta1*Delta3_prmS2y + 4*Delta2*Delta2_prmS2y - 4*Delta4_prmS2y)/(2*etaKminus1) - (-5*Delta1**3*Delta2_prmS2y + 5*Delta1**2*Delta3_prmS2y + 10*Delta1*Delta2*Delta2_prmS2y - 5*Delta1*Delta4_prmS2y - 5*Delta2*Delta3_prmS2y - 5*Delta2_prmS2y*Delta3)/(5*etaKminus1**2))
    logarg_prmS2y = u**2*(Delta2_prmS2y + u*(Delta3_prmS2y + u*(Delta4_prmS2y + Delta5_prmS2y*u)))
    Deltaucalib_prmS2y = eta*logarg_prmS2y*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmS2y = eta*logarg_prmS2y*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**3*(2*Delta2_prmS2y + u*(3*Delta3_prmS2y + u*(4*Delta4_prmS2y + 5*Delta5_prmS2y*u)))/(logarg + 1)
    Deltaubar_prmS2y = 2*a*a_prmS2y*u**2
    Deltaubarprime_prmS2y = -4*a*a_prmS2y*u**3
    ...
    sigmacoeffTerm2_prmS2y = eta*(eta*r*(-882*DrSipn2_prmS2y + 204*Qminus1_prmS2y + r*(1620*DrSipn2*DrSipn2_prmS2y - 234*DrSipn2*Qminus1_prmS2y - 234*DrSipn2_prmS2y*Qminus1)) + r*(-96*DrSipn2_prmS2y - 436*Qminus1_prmS2y + r*(36*DrSipn2*Qminus1_prmS2y + 36*DrSipn2_prmS2y*Qminus1 - 90*Qminus1*Qminus1_prmS2y)))/(144*r**2)
    sigmacoeffTerm1_prmS2y = eta*(-3*DrSipn2_prmS2y + Qminus1_prmS2y/4)
    sigmacoeff_prmS2y = sigmacoeffTerm1_prmS2y + sigmacoeffTerm2_prmS2y
    ...
    SdotSkerrhat_prmS2y = S1*Skerrhat1_prmS2y + S1_prmS2y*Skerrhat1 + S2*Skerrhat2_prmS2y + S2_prmS2y*Skerrhat2 + S3*Skerrhat3_prmS2y + S3_prmS2y*Skerrhat3
    ...
    HssTerm1_prmS2y = SdotSkerrhat*omega_prmS2y + SdotSkerrhat_prmS2y*omega
    ...
    HsoTerm2coeff_prmS2y = expnu*(-Q_prmS2y - Q_prmS2y/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmS2y/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmS2y/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmS2y*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmS2y*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmS2y = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmS2y + expmu*expnu_prmS2y + expmu_prmS2y*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmS2y*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmS2y*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmS2y*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmS2y*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmS2y*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmS2y*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmS2y*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmS2y = -Hd_prmS2y + Hns_prmS2y + Hs_prmS2y + 2*S2y*dSS*eta*u**4
...
def v4P_compute_ham_S2z_deriv(m1, m2, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    lambdahat_dot_Skerrhat_prmS2z = Skerrhat1_prmS2z*lambdahat1 + Skerrhat2_prmS2z*lambdahat2 + Skerrhat3_prmS2z*lambdahat3
    lambdahat_cross_Skerrhat3_prmS2z = -Skerrhat1_prmS2z*lambdahat2 + Skerrhat2_prmS2z*lambdahat1
    lambdahat_cross_Skerrhat2_prmS2z = Skerrhat1_prmS2z*lambdahat3 - Skerrhat3_prmS2z*lambdahat1
    lambdahat_cross_Skerrhat1_prmS2z = -Skerrhat2_prmS2z*lambdahat3 + Skerrhat3_prmS2z*lambdahat2
    Skerrhat_dot_n_prmS2z = Skerrhat1_prmS2z*n1 + Skerrhat2_prmS2z*n2 + Skerrhat3_prmS2z*n3
    condition_lhs_prmS2z = -Skerrhat_dot_n_prmS2z*np.sign(Skerrhat_dot_n)
    greaterthan_bound_prmS2z = -condition_lhs_prmS2z*(condition_lhs/2 - condition_rhs/2 + np.abs(condition_lhs - condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS2z*np.sign(condition_lhs - condition_rhs)/2 + condition_lhs_prmS2z/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    lesserthan_equal_bound_prmS2z = -condition_lhs_prmS2z*(-TINYDOUBLE/2 + condition_lhs/2 - condition_rhs/2 - np.abs(TINYDOUBLE - condition_lhs + condition_rhs)/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)**2 + (condition_lhs_prmS2z*np.sign(TINYDOUBLE - condition_lhs + condition_rhs)/2 + condition_lhs_prmS2z/2)/(-TINYDOUBLE + condition_lhs - condition_rhs)
    e31_prmS2z = Skerrhat1*greaterthan_bound_prmS2z + Skerrhat1_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2z*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2z*sin_0_1_deg) + lesserthan_equal_bound_prmS2z*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg)
    e32_prmS2z = Skerrhat2*greaterthan_bound_prmS2z + Skerrhat2_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2z*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2z*sin_0_1_deg) + lesserthan_equal_bound_prmS2z*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg)
    e33_prmS2z = Skerrhat3*greaterthan_bound_prmS2z + Skerrhat3_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2z*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2z*sin_0_1_deg) + lesserthan_equal_bound_prmS2z*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg)
    ...
    Delta2_prmS2z = -2*Delta0*a*a_prmS2z*etaKminus1**2
    Delta3_prmS2z = Delta1*Delta2_prmS2z - 2*Delta1*a*a_prmS2z*etaKminus1**2 - 2*Delta2_prmS2z*etaKminus1
    Delta4_prmS2z = -Delta1**2*Delta2_prmS2z + Delta1*(2*Delta2_prmS2z*etaKminus1 + Delta3_prmS2z) + Delta2*Delta2_prmS2z - Delta2_prmS2z*a**2*etaKminus1**2 - 2*Delta3_prmS2z*etaKminus1 + a*a_prmS2z*etaKminus1**2*(Delta1**2 - 2*Delta2)
    Delta5_prmS2z = etaKminus1**2*(-a**2*(-3*Delta1*Delta2_prmS2z + 3*Delta3_prmS2z)/3 + a*a_prmS2z*(-2*Delta1**3 + 6*Delta1*Delta2 - 6*Delta3)/3 + (-4*Delta1**2*Delta2_prmS2z + 4*Delta1*Delta3_prmS2z + 4*Delta2*Delta2_prmS2z - 4*Delta4_prmS2z)/(2*etaKminus1) - (-5*Delta1**3*Delta2_prmS2z + 5*Delta1**2*Delta3_prmS2z + 10*Delta1*Delta2*Delta2_prmS2z - 5*Delta1*Delta4_prmS2z - 5*Delta2*Delta3_prmS2z - 5*Delta2_prmS2z*Delta3)/(5*etaKminus1**2))
    logarg_prmS2z = u**2*(Delta2_prmS2z + u*(Delta3_prmS2z + u*(Delta4_prmS2z + Delta5_prmS2z*u)))
    Deltaucalib_prmS2z = eta*logarg_prmS2z*np.sign(logarg + 1)/np.abs(logarg + 1)
    Deltaucalibprime_prmS2z = eta*logarg_prmS2z*u**2*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*np.log(u))))))/(logarg + 1)**2 - eta*u**3*(2*Delta2_prmS2z + u*(3*Delta3_prmS2z + u*(4*Delta4_prmS2z + 5*Delta5_prmS2z*u)))/(logarg + 1)
    Deltaubar_prmS2z = 2*a*a_prmS2z*u**2
    Deltaubarprime_prmS2z = -4*a*a_prmS2z*u**3
    ...
    sigmacoeffTerm2_prmS2z = eta*(eta*r*(-882*DrSipn2_prmS2z + 204*Qminus1_prmS2z + r*(1620*DrSipn2*DrSipn2_prmS2z - 234*DrSipn2*Qminus1_prmS2z - 234*DrSipn2_prmS2z*Qminus1)) + r*(-96*DrSipn2_prmS2z - 436*Qminus1_prmS2z + r*(36*DrSipn2*Qminus1_prmS2z + 36*DrSipn2_prmS2z*Qminus1 - 90*Qminus1*Qminus1_prmS2z)))/(144*r**2)
    sigmacoeffTerm1_prmS2z = eta*(-3*DrSipn2_prmS2z + Qminus1_prmS2z/4)
    sigmacoeff_prmS2z = sigmacoeffTerm1_prmS2z + sigmacoeffTerm2_prmS2z
    ...
    SdotSkerrhat_prmS2z = S1*Skerrhat1_prmS2z + S1_prmS2z*Skerrhat1 + S2*Skerrhat2_prmS2z + S2_prmS2z*Skerrhat2 + S3*Skerrhat3_prmS2z + S3_prmS2z*Skerrhat3
    ...
    HssTerm1_prmS2z = SdotSkerrhat*omega_prmS2z + SdotSkerrhat_prmS2z*omega
    ...
    HsoTerm2coeff_prmS2z = expnu*(-Q_prmS2z - Q_prmS2z/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - expnu*xisq_prmS2z/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)) + expnu_prmS2z/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)) - exp2mu_prmS2z*expnu/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)) - 2*Btilde_prmS2z*expnu/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q))
    HsoTerm1_prmS2z = SdotSkerrhat*exp2nu*pdotxir*(-Btilde_prmS2z + expmu*expnu_prmS2z + expmu_prmS2z*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmS2z*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhat*exp2nu*pdotxir_prmS2z*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmS2z*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_prmS2z*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmS2z*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_prmS2z*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Btilde_prmS2z*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq)
    ...
    Heff_prmS2z = -Hd_prmS2z + Hns_prmS2z + Hs_prmS2z + 2*S2z*dSS*eta*u**4
