...
def ham_first_derivs(m1, m2, tortoise, x1, x2, x3, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    return np.array([Hreal_prmx1, Hreal_prmx2, Hreal_prmx3, Hreal_prmp1, Hreal_prmp2, Hreal_prmp3, Hreal_prmS1x, Hreal_prmS1y, Hreal_prmS1z, Hreal_prmS2x, Hreal_prmS2y, Hreal_prmS2z])
