...
import numpy as np
def ham_first_derivs(m1, m2, EMgamma, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    Deltau_prmx = Deltaubar*Deltaucalib_prmx + Deltaubar_prmx*Deltaucalib
    Deltau_prmy = Deltaubar*Deltaucalib_prmy + Deltaubar_prmy*Deltaucalib
    Deltau_prmz = Deltaubar*Deltaucalib_prmz + Deltaubar_prmz*Deltaucalib
    Deltau_prmp1 = Deltaubar*Deltaucalib_prmp1 + Deltaubar_prmp1*Deltaucalib
    Deltau_prmp2 = Deltaubar*Deltaucalib_prmp2 + Deltaubar_prmp2*Deltaucalib
    Deltau_prmp3 = Deltaubar*Deltaucalib_prmp3 + Deltaubar_prmp3*Deltaucalib
    Deltau_prmS1x = Deltaubar*Deltaucalib_prmS1x + Deltaubar_prmS1x*Deltaucalib
    Deltau_prmS1y = Deltaubar*Deltaucalib_prmS1y + Deltaubar_prmS1y*Deltaucalib
    Deltau_prmS1z = Deltaubar*Deltaucalib_prmS1z + Deltaubar_prmS1z*Deltaucalib
    Deltau_prmS2x = Deltaubar*Deltaucalib_prmS2x + Deltaubar_prmS2x*Deltaucalib
    Deltau_prmS2y = Deltaubar*Deltaucalib_prmS2y + Deltaubar_prmS2y*Deltaucalib
    Deltau_prmS2z = Deltaubar*Deltaucalib_prmS2z + Deltaubar_prmS2z*Deltaucalib
    ...
    Lambt_prmx = -Deltat*a**2*sin2theta_prmx - Deltat_prmx*a**2*sin2theta + 2*w2*w2_prmx
    Lambt_prmy = -Deltat*a**2*sin2theta_prmy - Deltat_prmy*a**2*sin2theta + 2*w2*w2_prmy
    Lambt_prmz = -Deltat*a**2*sin2theta_prmz - Deltat_prmz*a**2*sin2theta + 2*w2*w2_prmz
    Lambt_prmp1 = -Deltat_prmp1*a**2*sin2theta
    Lambt_prmp2 = -Deltat_prmp2*a**2*sin2theta
    Lambt_prmp3 = -Deltat_prmp3*a**2*sin2theta
    Lambt_prmS1x = -Deltat*a**2*sin2theta_prmS1x - 2*Deltat*a*a_prmS1x*sin2theta - Deltat_prmS1x*a**2*sin2theta + 2*w2*w2_prmS1x
    Lambt_prmS1y = -Deltat*a**2*sin2theta_prmS1y - 2*Deltat*a*a_prmS1y*sin2theta - Deltat_prmS1y*a**2*sin2theta + 2*w2*w2_prmS1y
    Lambt_prmS1z = -Deltat*a**2*sin2theta_prmS1z - 2*Deltat*a*a_prmS1z*sin2theta - Deltat_prmS1z*a**2*sin2theta + 2*w2*w2_prmS1z
    Lambt_prmS2x = -Deltat*a**2*sin2theta_prmS2x - 2*Deltat*a*a_prmS2x*sin2theta - Deltat_prmS2x*a**2*sin2theta + 2*w2*w2_prmS2x
    Lambt_prmS2y = -Deltat*a**2*sin2theta_prmS2y - 2*Deltat*a*a_prmS2y*sin2theta - Deltat_prmS2y*a**2*sin2theta + 2*w2*w2_prmS2y
    Lambt_prmS2z = -Deltat*a**2*sin2theta_prmS2z - 2*Deltat*a*a_prmS2z*sin2theta - Deltat_prmS2z*a**2*sin2theta + 2*w2*w2_prmS2z
