...
double ham_x_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat = Skerrhat1*lambdahat1 + Skerrhat2*lambdahat2 + Skerrhat3*lambdahat3;
    double lambdahat_cross_Skerrhat3 = -Skerrhat1*lambdahat2 + Skerrhat2*lambdahat1;
    double lambdahat_cross_Skerrhat2 = Skerrhat1*lambdahat3 - Skerrhat3*lambdahat1;
    double lambdahat_cross_Skerrhat1 = -Skerrhat2*lambdahat3 + Skerrhat3*lambdahat2;
    ...
    double condition_rhs = 1.0e-8;
    double greaterthan_bound = ((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound = (-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31 = Skerrhat1*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32 = Skerrhat2*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33 = Skerrhat3*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double lambdahat_dot_Skerrhat_prmx = Skerrhat1*lambdahat1_prmx + Skerrhat2*lambdahat2_prmx + Skerrhat3*lambdahat3_prmx;
    double lambdahat_cross_Skerrhat3_prmx = -Skerrhat1*lambdahat2_prmx + Skerrhat2*lambdahat1_prmx;
    double lambdahat_cross_Skerrhat2_prmx = Skerrhat1*lambdahat3_prmx - Skerrhat3*lambdahat1_prmx;
    double lambdahat_cross_Skerrhat1_prmx = -Skerrhat2*lambdahat3_prmx + Skerrhat3*lambdahat2_prmx;
    double Skerrhat_dot_n_prmx = Skerrhat1*n1_prmx + Skerrhat2*n2_prmx + Skerrhat3*n3_prmx;
    double condition_lhs_prmx = -Skerrhat_dot_n_prmx*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmx = -condition_lhs_prmx*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmx*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmx)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmx = -condition_lhs_prmx*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmx*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmx)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmx = Skerrhat1*greaterthan_bound_prmx + lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat1_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmx*sin_0_1_deg) + lesserthan_equal_bound_prmx*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmx = Skerrhat2*greaterthan_bound_prmx + lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat2_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmx*sin_0_1_deg) + lesserthan_equal_bound_prmx*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmx = Skerrhat3*greaterthan_bound_prmx + lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat3_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmx*sin_0_1_deg) + lesserthan_equal_bound_prmx*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double logarg_prmx = u*(u*(u*(u*(Delta5l*u_prmx + u_prmx*(Delta5 + Delta5l*log(u))) + u_prmx*(Delta4 + u*(Delta5 + Delta5l*log(u)))) + u_prmx*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u))))) + u_prmx*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u)))))) + u_prmx*(Delta1 + u*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u))))));
    double Deltaucalib_prmx = eta*logarg_prmx*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmx = eta*logarg_prmx*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 2)*(u*(u*(u*(5*Delta5l*u_prmx + u_prmx*(5*Delta5 + 5*Delta5l*log(u))) + u_prmx*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u)))) + u_prmx*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))) + u_prmx*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/(logarg + 1) + eta*u*u_prmx*(-2*Delta1 - 2*u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/(logarg + 1);
    double Deltaubar_prmx = 2*pow(a, 2)*u*u_prmx + 2*u_prmx/etaKminus1;
    double Deltaubarprime_prmx = -6*pow(a, 2)*pow(u, 2)*u_prmx - 4*u*u_prmx/etaKminus1;
    ...
    double sigmacoeffTerm3_prmx = 3*dSO*eta*pow(u, 2)*u_prmx;
    ...
    double Heff_prmx = -Hd_prmx + Hns_prmx + Hs_prmx + dSS*eta*pow(u, 3)*u_prmx*(4*pow(S1x, 2) + 4*pow(S1y, 2) + 4*pow(S1z, 2) + 4*pow(S2x, 2) + 4*pow(S2y, 2) + 4*pow(S2z, 2));
...
double ham_y_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmy = Skerrhat1*lambdahat1_prmy + Skerrhat2*lambdahat2_prmy + Skerrhat3*lambdahat3_prmy;
    double lambdahat_cross_Skerrhat3_prmy = -Skerrhat1*lambdahat2_prmy + Skerrhat2*lambdahat1_prmy;
    double lambdahat_cross_Skerrhat2_prmy = Skerrhat1*lambdahat3_prmy - Skerrhat3*lambdahat1_prmy;
    double lambdahat_cross_Skerrhat1_prmy = -Skerrhat2*lambdahat3_prmy + Skerrhat3*lambdahat2_prmy;
    double Skerrhat_dot_n_prmy = Skerrhat1*n1_prmy + Skerrhat2*n2_prmy + Skerrhat3*n3_prmy;
    double condition_lhs_prmy = -Skerrhat_dot_n_prmy*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmy = -condition_lhs_prmy*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmy*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmy)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmy = -condition_lhs_prmy*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmy*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmy)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmy = Skerrhat1*greaterthan_bound_prmy + lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat1_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmy*sin_0_1_deg) + lesserthan_equal_bound_prmy*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmy = Skerrhat2*greaterthan_bound_prmy + lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat2_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmy*sin_0_1_deg) + lesserthan_equal_bound_prmy*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmy = Skerrhat3*greaterthan_bound_prmy + lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat3_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmy*sin_0_1_deg) + lesserthan_equal_bound_prmy*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double logarg_prmy = u*(u*(u*(u*(Delta5l*u_prmy + u_prmy*(Delta5 + Delta5l*log(u))) + u_prmy*(Delta4 + u*(Delta5 + Delta5l*log(u)))) + u_prmy*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u))))) + u_prmy*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u)))))) + u_prmy*(Delta1 + u*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u))))));
    double Deltaucalib_prmy = eta*logarg_prmy*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmy = eta*logarg_prmy*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 2)*(u*(u*(u*(5*Delta5l*u_prmy + u_prmy*(5*Delta5 + 5*Delta5l*log(u))) + u_prmy*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u)))) + u_prmy*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))) + u_prmy*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/(logarg + 1) + eta*u*u_prmy*(-2*Delta1 - 2*u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/(logarg + 1);
    double Deltaubar_prmy = 2*pow(a, 2)*u*u_prmy + 2*u_prmy/etaKminus1;
    double Deltaubarprime_prmy = -6*pow(a, 2)*pow(u, 2)*u_prmy - 4*u*u_prmy/etaKminus1;
    ...
    double sigmacoeffTerm3_prmy = 3*dSO*eta*pow(u, 2)*u_prmy;
    ...
    double Heff_prmy = -Hd_prmy + Hns_prmy + Hs_prmy + dSS*eta*pow(u, 3)*u_prmy*(4*pow(S1x, 2) + 4*pow(S1y, 2) + 4*pow(S1z, 2) + 4*pow(S2x, 2) + 4*pow(S2y, 2) + 4*pow(S2z, 2));
...
double ham_z_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmz = Skerrhat1*lambdahat1_prmz + Skerrhat2*lambdahat2_prmz + Skerrhat3*lambdahat3_prmz;
    double lambdahat_cross_Skerrhat3_prmz = -Skerrhat1*lambdahat2_prmz + Skerrhat2*lambdahat1_prmz;
    double lambdahat_cross_Skerrhat2_prmz = Skerrhat1*lambdahat3_prmz - Skerrhat3*lambdahat1_prmz;
    double lambdahat_cross_Skerrhat1_prmz = -Skerrhat2*lambdahat3_prmz + Skerrhat3*lambdahat2_prmz;
    double Skerrhat_dot_n_prmz = Skerrhat1*n1_prmz + Skerrhat2*n2_prmz + Skerrhat3*n3_prmz;
    double condition_lhs_prmz = -Skerrhat_dot_n_prmz*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmz = -condition_lhs_prmz*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmz*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmz)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmz = -condition_lhs_prmz*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmz*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmz)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmz = Skerrhat1*greaterthan_bound_prmz + lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat1_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmz*sin_0_1_deg) + lesserthan_equal_bound_prmz*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmz = Skerrhat2*greaterthan_bound_prmz + lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat2_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmz*sin_0_1_deg) + lesserthan_equal_bound_prmz*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmz = Skerrhat3*greaterthan_bound_prmz + lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat3_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmz*sin_0_1_deg) + lesserthan_equal_bound_prmz*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double logarg_prmz = u*(u*(u*(u*(Delta5l*u_prmz + u_prmz*(Delta5 + Delta5l*log(u))) + u_prmz*(Delta4 + u*(Delta5 + Delta5l*log(u)))) + u_prmz*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u))))) + u_prmz*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u)))))) + u_prmz*(Delta1 + u*(Delta2 + u*(Delta3 + u*(Delta4 + u*(Delta5 + Delta5l*log(u))))));
    double Deltaucalib_prmz = eta*logarg_prmz*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmz = eta*logarg_prmz*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 2)*(u*(u*(u*(5*Delta5l*u_prmz + u_prmz*(5*Delta5 + 5*Delta5l*log(u))) + u_prmz*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u)))) + u_prmz*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))) + u_prmz*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/(logarg + 1) + eta*u*u_prmz*(-2*Delta1 - 2*u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/(logarg + 1);
    double Deltaubar_prmz = 2*pow(a, 2)*u*u_prmz + 2*u_prmz/etaKminus1;
    double Deltaubarprime_prmz = -6*pow(a, 2)*pow(u, 2)*u_prmz - 4*u*u_prmz/etaKminus1;
    ...
    double sigmacoeffTerm3_prmz = 3*dSO*eta*pow(u, 2)*u_prmz;
    ...
    double Heff_prmz = -Hd_prmz + Hns_prmz + Hs_prmz + dSS*eta*pow(u, 3)*u_prmz*(4*pow(S1x, 2) + 4*pow(S1y, 2) + 4*pow(S1z, 2) + 4*pow(S2x, 2) + 4*pow(S2y, 2) + 4*pow(S2z, 2));
...
double ham_p1_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmp1 = Skerrhat1*lambdahat1_prmp1 + Skerrhat2*lambdahat2_prmp1 + Skerrhat3*lambdahat3_prmp1;
    double lambdahat_cross_Skerrhat3_prmp1 = -Skerrhat1*lambdahat2_prmp1 + Skerrhat2*lambdahat1_prmp1;
    double lambdahat_cross_Skerrhat2_prmp1 = Skerrhat1*lambdahat3_prmp1 - Skerrhat3*lambdahat1_prmp1;
    double lambdahat_cross_Skerrhat1_prmp1 = -Skerrhat2*lambdahat3_prmp1 + Skerrhat3*lambdahat2_prmp1;
    double e31_prmp1 = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmp1*(1 - cos_0_1_deg) + lambdahat1_prmp1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmp1*sin_0_1_deg);
    double e32_prmp1 = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmp1*(1 - cos_0_1_deg) + lambdahat2_prmp1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmp1*sin_0_1_deg);
    double e33_prmp1 = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmp1*(1 - cos_0_1_deg) + lambdahat3_prmp1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmp1*sin_0_1_deg);
    ...
    double Lambt_prmp1 = Deltat*pow(a, 2)*sin2theta_prmp1*(((Deltat*pow(a, 2)*sin2theta - pow(w2, 2)) > 0) - ((Deltat*pow(a, 2)*sin2theta - pow(w2, 2)) < 0));
    double prT_prmp1 = csi2*n1;
    double phat3_prmp1 = n3*prT_prmp1*(-1 + 1.0/csi1);
    double phat2_prmp1 = n2*prT_prmp1*(-1 + 1.0/csi1);
    double phat1_prmp1 = n1*prT_prmp1*(-1 + 1.0/csi1) + 1;
    ...
    double DrSipn2_prmp1 = 2*Deltar*pdotn*pdotn_prmp1/Sigma - Deltar*Sigma_prmp1*pow(pdotn, 2)/pow(Sigma, 2);
    ...
    double exp2nu_prmp1 = Deltat*Sigma_prmp1/Lambt - Deltat*Lambt_prmp1*Sigma/pow(Lambt, 2);
    double expnu_prmp1 = (1.0/2.0)*exp2nu_prmp1/sqrt(exp2nu);
    double omega_prmp1 = -Lambt_prmp1*omegatilde/pow(Lambt, 2);
    double Lambtprime_prmp1 = -Deltatprime*pow(a, 2)*sin2theta_prmp1;
    double mucostheta_prmp1 = pow(a, 2)*costheta_prmp1/Sigma - Sigma_prmp1*pow(a, 2)*costheta/pow(Sigma, 2);
    double nucostheta_prmp1 = pow(a, 2)*costheta_prmp1*w2*(-Deltat + w2)/(Lambt*Sigma) - Sigma_prmp1*pow(a, 2)*costheta*w2*(-Deltat + w2)/(Lambt*pow(Sigma, 2)) - Lambt_prmp1*pow(a, 2)*costheta*w2*(-Deltat + w2)/(pow(Lambt, 2)*Sigma);
    double omegacostheta_prmp1 = -2*Deltat*pow(a, 2)*costheta_prmp1*omegatilde/pow(Lambt, 2) + 4*Deltat*Lambt_prmp1*pow(a, 2)*costheta*omegatilde/pow(Lambt, 3);
    double mur_prmp1 = -Sigma_prmp1*r/pow(Sigma, 2);
    double nur_prmp1 = -Sigma_prmp1*r/pow(Sigma, 2) - 1.0/2.0*Lambt_prmp1*w2*(-4*Deltat*r + Deltatprime*w2)/(Deltat*pow(Lambt, 2));
    ...
    double sigmacoeff_prmp1 = sigmacoeffTerm1_prmp1 + sigmacoeffTerm2_prmp1;
    ...
    double Heff_prmp1 = -Hd_prmp1 + Hns_prmp1 + Hs_prmp1;
...
double ham_p2_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmp2 = Skerrhat1*lambdahat1_prmp2 + Skerrhat2*lambdahat2_prmp2 + Skerrhat3*lambdahat3_prmp2;
    double lambdahat_cross_Skerrhat3_prmp2 = -Skerrhat1*lambdahat2_prmp2 + Skerrhat2*lambdahat1_prmp2;
    double lambdahat_cross_Skerrhat2_prmp2 = Skerrhat1*lambdahat3_prmp2 - Skerrhat3*lambdahat1_prmp2;
    double lambdahat_cross_Skerrhat1_prmp2 = -Skerrhat2*lambdahat3_prmp2 + Skerrhat3*lambdahat2_prmp2;
    double e31_prmp2 = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmp2*(1 - cos_0_1_deg) + lambdahat1_prmp2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmp2*sin_0_1_deg);
    double e32_prmp2 = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmp2*(1 - cos_0_1_deg) + lambdahat2_prmp2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmp2*sin_0_1_deg);
    double e33_prmp2 = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmp2*(1 - cos_0_1_deg) + lambdahat3_prmp2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmp2*sin_0_1_deg);
    ...
    double Lambt_prmp2 = Deltat*pow(a, 2)*sin2theta_prmp2*(((Deltat*pow(a, 2)*sin2theta - pow(w2, 2)) > 0) - ((Deltat*pow(a, 2)*sin2theta - pow(w2, 2)) < 0));
    double prT_prmp2 = csi2*n2;
    double phat3_prmp2 = n3*prT_prmp2*(-1 + 1.0/csi1);
    double phat2_prmp2 = n2*prT_prmp2*(-1 + 1.0/csi1) + 1;
    double phat1_prmp2 = n1*prT_prmp2*(-1 + 1.0/csi1);
    ...
    double DrSipn2_prmp2 = 2*Deltar*pdotn*pdotn_prmp2/Sigma - Deltar*Sigma_prmp2*pow(pdotn, 2)/pow(Sigma, 2);
    ...
    double exp2nu_prmp2 = Deltat*Sigma_prmp2/Lambt - Deltat*Lambt_prmp2*Sigma/pow(Lambt, 2);
    double expnu_prmp2 = (1.0/2.0)*exp2nu_prmp2/sqrt(exp2nu);
    double omega_prmp2 = -Lambt_prmp2*omegatilde/pow(Lambt, 2);
    double Lambtprime_prmp2 = -Deltatprime*pow(a, 2)*sin2theta_prmp2;
    double mucostheta_prmp2 = pow(a, 2)*costheta_prmp2/Sigma - Sigma_prmp2*pow(a, 2)*costheta/pow(Sigma, 2);
    double nucostheta_prmp2 = pow(a, 2)*costheta_prmp2*w2*(-Deltat + w2)/(Lambt*Sigma) - Sigma_prmp2*pow(a, 2)*costheta*w2*(-Deltat + w2)/(Lambt*pow(Sigma, 2)) - Lambt_prmp2*pow(a, 2)*costheta*w2*(-Deltat + w2)/(pow(Lambt, 2)*Sigma);
    double omegacostheta_prmp2 = -2*Deltat*pow(a, 2)*costheta_prmp2*omegatilde/pow(Lambt, 2) + 4*Deltat*Lambt_prmp2*pow(a, 2)*costheta*omegatilde/pow(Lambt, 3);
    double mur_prmp2 = -Sigma_prmp2*r/pow(Sigma, 2);
    double nur_prmp2 = -Sigma_prmp2*r/pow(Sigma, 2) - 1.0/2.0*Lambt_prmp2*w2*(-4*Deltat*r + Deltatprime*w2)/(Deltat*pow(Lambt, 2));
    ...
    double sigmacoeff_prmp2 = sigmacoeffTerm1_prmp2 + sigmacoeffTerm2_prmp2;
    ...
    double HssTerm2_prmp2 = pow(Btilde, 2)*xisq*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn_prmp2 - Jtilde*Sdotv_prmp2*pdotn + Sdotn*pdotvr_prmp2 + Sdotn_prmp2*pdotvr) + Jtilde*pdotn_prmp2*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(Q_prmp2 + (1.0/2.0)*Q_prmp2/sqrt(Q)) + Sdotv*exp2mu_prmp2*(sqrt(Q) + Q) + Sdotv_prmp2*exp2mu*(sqrt(Q) + Q)) + pow(Btilde, 2)*xisq_prmp2*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(sqrt(Q) + Q)) + expmu*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr_prmp2 - Btilde*Sdotxi*expnu_prmp2*pdotvr - Btilde*Sdotxi_prmp2*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir_prmp2 + Sdotv*exp2nu*expmu_prmp2*pdotxir + Sdotv*exp2nu_prmp2*expmu*pdotxir + Sdotv_prmp2*exp2nu*expmu*pdotxir) + expmu*pdotxir_prmp2*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir) + expmu_prmp2*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir);
    ...
    double HsoTerm2coeff_prmp2 = expnu*(-Q_prmp2 - 1.0/2.0*Q_prmp2/sqrt(Q))/(pow(Btilde, 2)*exp2mu*xisq*pow(sqrt(Q) + Q, 2)) - expnu*xisq_prmp2/(pow(Btilde, 2)*exp2mu*pow(xisq, 2)*(sqrt(Q) + Q)) + expnu_prmp2/(pow(Btilde, 2)*exp2mu*xisq*(sqrt(Q) + Q)) - exp2mu_prmp2*expnu/(pow(Btilde, 2)*pow(exp2mu, 2)*xisq*(sqrt(Q) + Q));
    double HsoTerm1_prmp2 = SdotSkerrhat*exp2nu*pdotxir*(expmu*expnu_prmp2 + expmu_prmp2*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmp2*(Btilde - expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*pow(xisq, 2)) + SdotSkerrhat*exp2nu*pdotxir_prmp2*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmp2*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*pow(expmu, 2)*xisq) + SdotSkerrhat*exp2nu_prmp2*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmp2*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) - 1.0/2.0*Q_prmp2*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*pow(Q, 3.0/2.0)*expmu*xisq);
    ...
    double Heff_prmp2 = -Hd_prmp2 + Hns_prmp2 + Hs_prmp2;
...
double ham_p3_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmp3 = Skerrhat1*lambdahat1_prmp3 + Skerrhat2*lambdahat2_prmp3 + Skerrhat3*lambdahat3_prmp3;
    double lambdahat_cross_Skerrhat3_prmp3 = -Skerrhat1*lambdahat2_prmp3 + Skerrhat2*lambdahat1_prmp3;
    double lambdahat_cross_Skerrhat2_prmp3 = Skerrhat1*lambdahat3_prmp3 - Skerrhat3*lambdahat1_prmp3;
    double lambdahat_cross_Skerrhat1_prmp3 = -Skerrhat2*lambdahat3_prmp3 + Skerrhat3*lambdahat2_prmp3;
    double e31_prmp3 = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmp3*(1 - cos_0_1_deg) + lambdahat1_prmp3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmp3*sin_0_1_deg);
    double e32_prmp3 = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmp3*(1 - cos_0_1_deg) + lambdahat2_prmp3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmp3*sin_0_1_deg);
    double e33_prmp3 = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmp3*(1 - cos_0_1_deg) + lambdahat3_prmp3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmp3*sin_0_1_deg);
    ...
    double Lambt_prmp3 = Deltat*pow(a, 2)*sin2theta_prmp3*(((Deltat*pow(a, 2)*sin2theta - pow(w2, 2)) > 0) - ((Deltat*pow(a, 2)*sin2theta - pow(w2, 2)) < 0));
    double prT_prmp3 = csi2*n3;
    double phat3_prmp3 = n3*prT_prmp3*(-1 + 1.0/csi1) + 1;
    double phat2_prmp3 = n2*prT_prmp3*(-1 + 1.0/csi1);
    double phat1_prmp3 = n1*prT_prmp3*(-1 + 1.0/csi1);
    ...
    double DrSipn2_prmp3 = 2*Deltar*pdotn*pdotn_prmp3/Sigma - Deltar*Sigma_prmp3*pow(pdotn, 2)/pow(Sigma, 2);
    ...
    double exp2nu_prmp3 = Deltat*Sigma_prmp3/Lambt - Deltat*Lambt_prmp3*Sigma/pow(Lambt, 2);
    double expnu_prmp3 = (1.0/2.0)*exp2nu_prmp3/sqrt(exp2nu);
    double omega_prmp3 = -Lambt_prmp3*omegatilde/pow(Lambt, 2);
    double Lambtprime_prmp3 = -Deltatprime*pow(a, 2)*sin2theta_prmp3;
    double mucostheta_prmp3 = pow(a, 2)*costheta_prmp3/Sigma - Sigma_prmp3*pow(a, 2)*costheta/pow(Sigma, 2);
    double nucostheta_prmp3 = pow(a, 2)*costheta_prmp3*w2*(-Deltat + w2)/(Lambt*Sigma) - Sigma_prmp3*pow(a, 2)*costheta*w2*(-Deltat + w2)/(Lambt*pow(Sigma, 2)) - Lambt_prmp3*pow(a, 2)*costheta*w2*(-Deltat + w2)/(pow(Lambt, 2)*Sigma);
    double omegacostheta_prmp3 = -2*Deltat*pow(a, 2)*costheta_prmp3*omegatilde/pow(Lambt, 2) + 4*Deltat*Lambt_prmp3*pow(a, 2)*costheta*omegatilde/pow(Lambt, 3);
    double mur_prmp3 = -Sigma_prmp3*r/pow(Sigma, 2);
    double nur_prmp3 = -Sigma_prmp3*r/pow(Sigma, 2) - 1.0/2.0*Lambt_prmp3*w2*(-4*Deltat*r + Deltatprime*w2)/(Deltat*pow(Lambt, 2));
    ...
    double sigmacoeff_prmp3 = sigmacoeffTerm1_prmp3 + sigmacoeffTerm2_prmp3;
    ...
    double HssTerm2_prmp3 = pow(Btilde, 2)*xisq*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn_prmp3 - Jtilde*Sdotv_prmp3*pdotn + Sdotn*pdotvr_prmp3 + Sdotn_prmp3*pdotvr) + Jtilde*pdotn_prmp3*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(Q_prmp3 + (1.0/2.0)*Q_prmp3/sqrt(Q)) + Sdotv*exp2mu_prmp3*(sqrt(Q) + Q) + Sdotv_prmp3*exp2mu*(sqrt(Q) + Q)) + pow(Btilde, 2)*xisq_prmp3*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(sqrt(Q) + Q)) + expmu*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr_prmp3 - Btilde*Sdotxi*expnu_prmp3*pdotvr - Btilde*Sdotxi_prmp3*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir_prmp3 + Sdotv*exp2nu*expmu_prmp3*pdotxir + Sdotv*exp2nu_prmp3*expmu*pdotxir + Sdotv_prmp3*exp2nu*expmu*pdotxir) + expmu*pdotxir_prmp3*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir) + expmu_prmp3*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir);
    ...
    double HsoTerm2c_prmp3 = Brtilde*Jtilde*Sdotv*expmu*expnu*pdotxir_prmp3*(sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv*expmu*expnu_prmp3*pdotxir*(sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv*expmu_prmp3*expnu*pdotxir*(sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv_prmp3*expmu*expnu*pdotxir*(sqrt(Q) + 1) + (1.0/2.0)*Brtilde*Jtilde*Q_prmp3*Sdotv*expmu*expnu*pdotxir/sqrt(Q);
    double HsoTerm2b_prmp3 = Btilde*expmu*expnu*pdotxir*(2*sqrt(Q) + 1)*(Jtilde*Sdotv*nur_prmp3 + Jtilde*Sdotv_prmp3*nur - Sdotn*nucostheta*xisq_prmp3 - Sdotn*nucostheta_prmp3*xisq - Sdotn_prmp3*nucostheta*xisq) + Btilde*expmu*expnu*pdotxir_prmp3*(2*sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde*expmu*expnu_prmp3*pdotxir*(2*sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde*expmu_prmp3*expnu*pdotxir*(2*sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde*Q_prmp3*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/sqrt(Q);
    ...
    double HsoTerm2coeff_prmp3 = expnu*(-Q_prmp3 - 1.0/2.0*Q_prmp3/sqrt(Q))/(pow(Btilde, 2)*exp2mu*xisq*pow(sqrt(Q) + Q, 2)) - expnu*xisq_prmp3/(pow(Btilde, 2)*exp2mu*pow(xisq, 2)*(sqrt(Q) + Q)) + expnu_prmp3/(pow(Btilde, 2)*exp2mu*xisq*(sqrt(Q) + Q)) - exp2mu_prmp3*expnu/(pow(Btilde, 2)*pow(exp2mu, 2)*xisq*(sqrt(Q) + Q));
    double HsoTerm1_prmp3 = SdotSkerrhat*exp2nu*pdotxir*(expmu*expnu_prmp3 + expmu_prmp3*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxir*xisq_prmp3*(Btilde - expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*pow(xisq, 2)) + SdotSkerrhat*exp2nu*pdotxir_prmp3*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) - SdotSkerrhat*exp2nu*expmu_prmp3*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*pow(expmu, 2)*xisq) + SdotSkerrhat*exp2nu_prmp3*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) + SdotSkerrhat_prmp3*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*sqrt(Q)*expmu*xisq) - 1.0/2.0*Q_prmp3*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(pow(Btilde, 2)*pow(Q, 3.0/2.0)*expmu*xisq);
    ...
    double Heff_prmp3 = -Hd_prmp3 + Hns_prmp3 + Hs_prmp3;
...
double ham_S1x_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmS1x = Skerrhat1_prmS1x*lambdahat1 + Skerrhat2_prmS1x*lambdahat2 + Skerrhat3_prmS1x*lambdahat3;
    double lambdahat_cross_Skerrhat3_prmS1x = -Skerrhat1_prmS1x*lambdahat2 + Skerrhat2_prmS1x*lambdahat1;
    double lambdahat_cross_Skerrhat2_prmS1x = Skerrhat1_prmS1x*lambdahat3 - Skerrhat3_prmS1x*lambdahat1;
    double lambdahat_cross_Skerrhat1_prmS1x = -Skerrhat2_prmS1x*lambdahat3 + Skerrhat3_prmS1x*lambdahat2;
    double Skerrhat_dot_n_prmS1x = Skerrhat1_prmS1x*n1 + Skerrhat2_prmS1x*n2 + Skerrhat3_prmS1x*n3;
    double condition_lhs_prmS1x = -Skerrhat_dot_n_prmS1x*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmS1x = -condition_lhs_prmS1x*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS1x*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS1x)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmS1x = -condition_lhs_prmS1x*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS1x*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS1x)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmS1x = Skerrhat1*greaterthan_bound_prmS1x + Skerrhat1_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1x*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1x*sin_0_1_deg) + lesserthan_equal_bound_prmS1x*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmS1x = Skerrhat2*greaterthan_bound_prmS1x + Skerrhat2_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1x*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1x*sin_0_1_deg) + lesserthan_equal_bound_prmS1x*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmS1x = Skerrhat3*greaterthan_bound_prmS1x + Skerrhat3_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1x*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1x*sin_0_1_deg) + lesserthan_equal_bound_prmS1x*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double Delta2_prmS1x = -2*Delta0*a*a_prmS1x*pow(etaKminus1, 2);
    double Delta3_prmS1x = Delta1*Delta2_prmS1x - 2*Delta1*a*a_prmS1x*pow(etaKminus1, 2) - 2*Delta2_prmS1x*etaKminus1;
    double Delta4_prmS1x = -pow(Delta1, 2)*Delta2_prmS1x + Delta1*(2*Delta2_prmS1x*etaKminus1 + Delta3_prmS1x) + Delta2*Delta2_prmS1x - Delta2_prmS1x*pow(a, 2)*pow(etaKminus1, 2) - 2*Delta3_prmS1x*etaKminus1 + a*a_prmS1x*pow(etaKminus1, 2)*(pow(Delta1, 2) - 2*Delta2);
    double Delta5_prmS1x = pow(etaKminus1, 2)*(-1.0/3.0*pow(a, 2)*(-3*Delta1*Delta2_prmS1x + 3*Delta3_prmS1x) + (1.0/3.0)*a*a_prmS1x*(-2*pow(Delta1, 3) + 6*Delta1*Delta2 - 6*Delta3) + (1.0/2.0)*(-4*pow(Delta1, 2)*Delta2_prmS1x + 4*Delta1*Delta3_prmS1x + 4*Delta2*Delta2_prmS1x - 4*Delta4_prmS1x)/etaKminus1 - 1.0/5.0*(-5*pow(Delta1, 3)*Delta2_prmS1x + 5*pow(Delta1, 2)*Delta3_prmS1x + 10*Delta1*Delta2*Delta2_prmS1x - 5*Delta1*Delta4_prmS1x - 5*Delta2*Delta3_prmS1x - 5*Delta2_prmS1x*Delta3)/pow(etaKminus1, 2));
    double logarg_prmS1x = pow(u, 2)*(Delta2_prmS1x + u*(Delta3_prmS1x + u*(Delta4_prmS1x + Delta5_prmS1x*u)));
    double Deltaucalib_prmS1x = eta*logarg_prmS1x*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmS1x = eta*logarg_prmS1x*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 3)*(2*Delta2_prmS1x + u*(3*Delta3_prmS1x + u*(4*Delta4_prmS1x + 5*Delta5_prmS1x*u)))/(logarg + 1);
    double Deltaubar_prmS1x = 2*a*a_prmS1x*pow(u, 2);
    double Deltaubarprime_prmS1x = -4*a*a_prmS1x*pow(u, 3);
    ...
    double sigmacoeff_prmS1x = sigmacoeffTerm1_prmS1x + sigmacoeffTerm2_prmS1x;
    ...
    double Heff_prmS1x = -Hd_prmS1x + Hns_prmS1x + Hs_prmS1x + 2*S1x*dSS*eta*pow(u, 4);
...
double ham_S1y_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmS1y = Skerrhat1_prmS1y*lambdahat1 + Skerrhat2_prmS1y*lambdahat2 + Skerrhat3_prmS1y*lambdahat3;
    double lambdahat_cross_Skerrhat3_prmS1y = -Skerrhat1_prmS1y*lambdahat2 + Skerrhat2_prmS1y*lambdahat1;
    double lambdahat_cross_Skerrhat2_prmS1y = Skerrhat1_prmS1y*lambdahat3 - Skerrhat3_prmS1y*lambdahat1;
    double lambdahat_cross_Skerrhat1_prmS1y = -Skerrhat2_prmS1y*lambdahat3 + Skerrhat3_prmS1y*lambdahat2;
    double Skerrhat_dot_n_prmS1y = Skerrhat1_prmS1y*n1 + Skerrhat2_prmS1y*n2 + Skerrhat3_prmS1y*n3;
    double condition_lhs_prmS1y = -Skerrhat_dot_n_prmS1y*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmS1y = -condition_lhs_prmS1y*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS1y*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS1y)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmS1y = -condition_lhs_prmS1y*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS1y*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS1y)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmS1y = Skerrhat1*greaterthan_bound_prmS1y + Skerrhat1_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1y*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1y*sin_0_1_deg) + lesserthan_equal_bound_prmS1y*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmS1y = Skerrhat2*greaterthan_bound_prmS1y + Skerrhat2_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1y*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1y*sin_0_1_deg) + lesserthan_equal_bound_prmS1y*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmS1y = Skerrhat3*greaterthan_bound_prmS1y + Skerrhat3_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1y*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1y*sin_0_1_deg) + lesserthan_equal_bound_prmS1y*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double Delta2_prmS1y = -2*Delta0*a*a_prmS1y*pow(etaKminus1, 2);
    double Delta3_prmS1y = Delta1*Delta2_prmS1y - 2*Delta1*a*a_prmS1y*pow(etaKminus1, 2) - 2*Delta2_prmS1y*etaKminus1;
    double Delta4_prmS1y = -pow(Delta1, 2)*Delta2_prmS1y + Delta1*(2*Delta2_prmS1y*etaKminus1 + Delta3_prmS1y) + Delta2*Delta2_prmS1y - Delta2_prmS1y*pow(a, 2)*pow(etaKminus1, 2) - 2*Delta3_prmS1y*etaKminus1 + a*a_prmS1y*pow(etaKminus1, 2)*(pow(Delta1, 2) - 2*Delta2);
    double Delta5_prmS1y = pow(etaKminus1, 2)*(-1.0/3.0*pow(a, 2)*(-3*Delta1*Delta2_prmS1y + 3*Delta3_prmS1y) + (1.0/3.0)*a*a_prmS1y*(-2*pow(Delta1, 3) + 6*Delta1*Delta2 - 6*Delta3) + (1.0/2.0)*(-4*pow(Delta1, 2)*Delta2_prmS1y + 4*Delta1*Delta3_prmS1y + 4*Delta2*Delta2_prmS1y - 4*Delta4_prmS1y)/etaKminus1 - 1.0/5.0*(-5*pow(Delta1, 3)*Delta2_prmS1y + 5*pow(Delta1, 2)*Delta3_prmS1y + 10*Delta1*Delta2*Delta2_prmS1y - 5*Delta1*Delta4_prmS1y - 5*Delta2*Delta3_prmS1y - 5*Delta2_prmS1y*Delta3)/pow(etaKminus1, 2));
    double logarg_prmS1y = pow(u, 2)*(Delta2_prmS1y + u*(Delta3_prmS1y + u*(Delta4_prmS1y + Delta5_prmS1y*u)));
    double Deltaucalib_prmS1y = eta*logarg_prmS1y*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmS1y = eta*logarg_prmS1y*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 3)*(2*Delta2_prmS1y + u*(3*Delta3_prmS1y + u*(4*Delta4_prmS1y + 5*Delta5_prmS1y*u)))/(logarg + 1);
    double Deltaubar_prmS1y = 2*a*a_prmS1y*pow(u, 2);
    double Deltaubarprime_prmS1y = -4*a*a_prmS1y*pow(u, 3);
    ...
    double sigmacoeff_prmS1y = sigmacoeffTerm1_prmS1y + sigmacoeffTerm2_prmS1y;
    ...
    double Heff_prmS1y = -Hd_prmS1y + Hns_prmS1y + Hs_prmS1y + 2*S1y*dSS*eta*pow(u, 4);
...
double ham_S1z_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmS1z = Skerrhat1_prmS1z*lambdahat1 + Skerrhat2_prmS1z*lambdahat2 + Skerrhat3_prmS1z*lambdahat3;
    double lambdahat_cross_Skerrhat3_prmS1z = -Skerrhat1_prmS1z*lambdahat2 + Skerrhat2_prmS1z*lambdahat1;
    double lambdahat_cross_Skerrhat2_prmS1z = Skerrhat1_prmS1z*lambdahat3 - Skerrhat3_prmS1z*lambdahat1;
    double lambdahat_cross_Skerrhat1_prmS1z = -Skerrhat2_prmS1z*lambdahat3 + Skerrhat3_prmS1z*lambdahat2;
    double Skerrhat_dot_n_prmS1z = Skerrhat1_prmS1z*n1 + Skerrhat2_prmS1z*n2 + Skerrhat3_prmS1z*n3;
    double condition_lhs_prmS1z = -Skerrhat_dot_n_prmS1z*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmS1z = -condition_lhs_prmS1z*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS1z*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS1z)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmS1z = -condition_lhs_prmS1z*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS1z*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS1z)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmS1z = Skerrhat1*greaterthan_bound_prmS1z + Skerrhat1_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1z*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1z*sin_0_1_deg) + lesserthan_equal_bound_prmS1z*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmS1z = Skerrhat2*greaterthan_bound_prmS1z + Skerrhat2_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1z*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1z*sin_0_1_deg) + lesserthan_equal_bound_prmS1z*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmS1z = Skerrhat3*greaterthan_bound_prmS1z + Skerrhat3_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1z*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1z*sin_0_1_deg) + lesserthan_equal_bound_prmS1z*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double Delta2_prmS1z = -2*Delta0*a*a_prmS1z*pow(etaKminus1, 2);
    double Delta3_prmS1z = Delta1*Delta2_prmS1z - 2*Delta1*a*a_prmS1z*pow(etaKminus1, 2) - 2*Delta2_prmS1z*etaKminus1;
    double Delta4_prmS1z = -pow(Delta1, 2)*Delta2_prmS1z + Delta1*(2*Delta2_prmS1z*etaKminus1 + Delta3_prmS1z) + Delta2*Delta2_prmS1z - Delta2_prmS1z*pow(a, 2)*pow(etaKminus1, 2) - 2*Delta3_prmS1z*etaKminus1 + a*a_prmS1z*pow(etaKminus1, 2)*(pow(Delta1, 2) - 2*Delta2);
    double Delta5_prmS1z = pow(etaKminus1, 2)*(-1.0/3.0*pow(a, 2)*(-3*Delta1*Delta2_prmS1z + 3*Delta3_prmS1z) + (1.0/3.0)*a*a_prmS1z*(-2*pow(Delta1, 3) + 6*Delta1*Delta2 - 6*Delta3) + (1.0/2.0)*(-4*pow(Delta1, 2)*Delta2_prmS1z + 4*Delta1*Delta3_prmS1z + 4*Delta2*Delta2_prmS1z - 4*Delta4_prmS1z)/etaKminus1 - 1.0/5.0*(-5*pow(Delta1, 3)*Delta2_prmS1z + 5*pow(Delta1, 2)*Delta3_prmS1z + 10*Delta1*Delta2*Delta2_prmS1z - 5*Delta1*Delta4_prmS1z - 5*Delta2*Delta3_prmS1z - 5*Delta2_prmS1z*Delta3)/pow(etaKminus1, 2));
    double logarg_prmS1z = pow(u, 2)*(Delta2_prmS1z + u*(Delta3_prmS1z + u*(Delta4_prmS1z + Delta5_prmS1z*u)));
    double Deltaucalib_prmS1z = eta*logarg_prmS1z*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmS1z = eta*logarg_prmS1z*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 3)*(2*Delta2_prmS1z + u*(3*Delta3_prmS1z + u*(4*Delta4_prmS1z + 5*Delta5_prmS1z*u)))/(logarg + 1);
    double Deltaubar_prmS1z = 2*a*a_prmS1z*pow(u, 2);
    double Deltaubarprime_prmS1z = -4*a*a_prmS1z*pow(u, 3);
    ...
    double sigmacoeff_prmS1z = sigmacoeffTerm1_prmS1z + sigmacoeffTerm2_prmS1z;
    ...
    double Heff_prmS1z = -Hd_prmS1z + Hns_prmS1z + Hs_prmS1z + 2*S1z*dSS*eta*pow(u, 4);
...
double ham_S2x_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmS2x = Skerrhat1_prmS2x*lambdahat1 + Skerrhat2_prmS2x*lambdahat2 + Skerrhat3_prmS2x*lambdahat3;
    double lambdahat_cross_Skerrhat3_prmS2x = -Skerrhat1_prmS2x*lambdahat2 + Skerrhat2_prmS2x*lambdahat1;
    double lambdahat_cross_Skerrhat2_prmS2x = Skerrhat1_prmS2x*lambdahat3 - Skerrhat3_prmS2x*lambdahat1;
    double lambdahat_cross_Skerrhat1_prmS2x = -Skerrhat2_prmS2x*lambdahat3 + Skerrhat3_prmS2x*lambdahat2;
    double Skerrhat_dot_n_prmS2x = Skerrhat1_prmS2x*n1 + Skerrhat2_prmS2x*n2 + Skerrhat3_prmS2x*n3;
    double condition_lhs_prmS2x = -Skerrhat_dot_n_prmS2x*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmS2x = -condition_lhs_prmS2x*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS2x*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS2x)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmS2x = -condition_lhs_prmS2x*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS2x*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS2x)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmS2x = Skerrhat1*greaterthan_bound_prmS2x + Skerrhat1_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2x*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2x*sin_0_1_deg) + lesserthan_equal_bound_prmS2x*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmS2x = Skerrhat2*greaterthan_bound_prmS2x + Skerrhat2_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2x*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2x*sin_0_1_deg) + lesserthan_equal_bound_prmS2x*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmS2x = Skerrhat3*greaterthan_bound_prmS2x + Skerrhat3_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2x*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2x*sin_0_1_deg) + lesserthan_equal_bound_prmS2x*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double Delta2_prmS2x = -2*Delta0*a*a_prmS2x*pow(etaKminus1, 2);
    double Delta3_prmS2x = Delta1*Delta2_prmS2x - 2*Delta1*a*a_prmS2x*pow(etaKminus1, 2) - 2*Delta2_prmS2x*etaKminus1;
    double Delta4_prmS2x = -pow(Delta1, 2)*Delta2_prmS2x + Delta1*(2*Delta2_prmS2x*etaKminus1 + Delta3_prmS2x) + Delta2*Delta2_prmS2x - Delta2_prmS2x*pow(a, 2)*pow(etaKminus1, 2) - 2*Delta3_prmS2x*etaKminus1 + a*a_prmS2x*pow(etaKminus1, 2)*(pow(Delta1, 2) - 2*Delta2);
    double Delta5_prmS2x = pow(etaKminus1, 2)*(-1.0/3.0*pow(a, 2)*(-3*Delta1*Delta2_prmS2x + 3*Delta3_prmS2x) + (1.0/3.0)*a*a_prmS2x*(-2*pow(Delta1, 3) + 6*Delta1*Delta2 - 6*Delta3) + (1.0/2.0)*(-4*pow(Delta1, 2)*Delta2_prmS2x + 4*Delta1*Delta3_prmS2x + 4*Delta2*Delta2_prmS2x - 4*Delta4_prmS2x)/etaKminus1 - 1.0/5.0*(-5*pow(Delta1, 3)*Delta2_prmS2x + 5*pow(Delta1, 2)*Delta3_prmS2x + 10*Delta1*Delta2*Delta2_prmS2x - 5*Delta1*Delta4_prmS2x - 5*Delta2*Delta3_prmS2x - 5*Delta2_prmS2x*Delta3)/pow(etaKminus1, 2));
    double logarg_prmS2x = pow(u, 2)*(Delta2_prmS2x + u*(Delta3_prmS2x + u*(Delta4_prmS2x + Delta5_prmS2x*u)));
    double Deltaucalib_prmS2x = eta*logarg_prmS2x*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmS2x = eta*logarg_prmS2x*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 3)*(2*Delta2_prmS2x + u*(3*Delta3_prmS2x + u*(4*Delta4_prmS2x + 5*Delta5_prmS2x*u)))/(logarg + 1);
    double Deltaubar_prmS2x = 2*a*a_prmS2x*pow(u, 2);
    double Deltaubarprime_prmS2x = -4*a*a_prmS2x*pow(u, 3);
    ...
    double sigmacoeff_prmS2x = sigmacoeffTerm1_prmS2x + sigmacoeffTerm2_prmS2x;
    ...
    double Heff_prmS2x = -Hd_prmS2x + Hns_prmS2x + Hs_prmS2x + 2*S2x*dSS*eta*pow(u, 4);
...
double ham_S2y_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmS2y = Skerrhat1_prmS2y*lambdahat1 + Skerrhat2_prmS2y*lambdahat2 + Skerrhat3_prmS2y*lambdahat3;
    double lambdahat_cross_Skerrhat3_prmS2y = -Skerrhat1_prmS2y*lambdahat2 + Skerrhat2_prmS2y*lambdahat1;
    double lambdahat_cross_Skerrhat2_prmS2y = Skerrhat1_prmS2y*lambdahat3 - Skerrhat3_prmS2y*lambdahat1;
    double lambdahat_cross_Skerrhat1_prmS2y = -Skerrhat2_prmS2y*lambdahat3 + Skerrhat3_prmS2y*lambdahat2;
    double Skerrhat_dot_n_prmS2y = Skerrhat1_prmS2y*n1 + Skerrhat2_prmS2y*n2 + Skerrhat3_prmS2y*n3;
    double condition_lhs_prmS2y = -Skerrhat_dot_n_prmS2y*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmS2y = -condition_lhs_prmS2y*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS2y*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS2y)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmS2y = -condition_lhs_prmS2y*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS2y*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS2y)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmS2y = Skerrhat1*greaterthan_bound_prmS2y + Skerrhat1_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2y*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2y*sin_0_1_deg) + lesserthan_equal_bound_prmS2y*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmS2y = Skerrhat2*greaterthan_bound_prmS2y + Skerrhat2_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2y*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2y*sin_0_1_deg) + lesserthan_equal_bound_prmS2y*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmS2y = Skerrhat3*greaterthan_bound_prmS2y + Skerrhat3_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2y*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2y*sin_0_1_deg) + lesserthan_equal_bound_prmS2y*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double Delta2_prmS2y = -2*Delta0*a*a_prmS2y*pow(etaKminus1, 2);
    double Delta3_prmS2y = Delta1*Delta2_prmS2y - 2*Delta1*a*a_prmS2y*pow(etaKminus1, 2) - 2*Delta2_prmS2y*etaKminus1;
    double Delta4_prmS2y = -pow(Delta1, 2)*Delta2_prmS2y + Delta1*(2*Delta2_prmS2y*etaKminus1 + Delta3_prmS2y) + Delta2*Delta2_prmS2y - Delta2_prmS2y*pow(a, 2)*pow(etaKminus1, 2) - 2*Delta3_prmS2y*etaKminus1 + a*a_prmS2y*pow(etaKminus1, 2)*(pow(Delta1, 2) - 2*Delta2);
    double Delta5_prmS2y = pow(etaKminus1, 2)*(-1.0/3.0*pow(a, 2)*(-3*Delta1*Delta2_prmS2y + 3*Delta3_prmS2y) + (1.0/3.0)*a*a_prmS2y*(-2*pow(Delta1, 3) + 6*Delta1*Delta2 - 6*Delta3) + (1.0/2.0)*(-4*pow(Delta1, 2)*Delta2_prmS2y + 4*Delta1*Delta3_prmS2y + 4*Delta2*Delta2_prmS2y - 4*Delta4_prmS2y)/etaKminus1 - 1.0/5.0*(-5*pow(Delta1, 3)*Delta2_prmS2y + 5*pow(Delta1, 2)*Delta3_prmS2y + 10*Delta1*Delta2*Delta2_prmS2y - 5*Delta1*Delta4_prmS2y - 5*Delta2*Delta3_prmS2y - 5*Delta2_prmS2y*Delta3)/pow(etaKminus1, 2));
    double logarg_prmS2y = pow(u, 2)*(Delta2_prmS2y + u*(Delta3_prmS2y + u*(Delta4_prmS2y + Delta5_prmS2y*u)));
    double Deltaucalib_prmS2y = eta*logarg_prmS2y*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmS2y = eta*logarg_prmS2y*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 3)*(2*Delta2_prmS2y + u*(3*Delta3_prmS2y + u*(4*Delta4_prmS2y + 5*Delta5_prmS2y*u)))/(logarg + 1);
    double Deltaubar_prmS2y = 2*a*a_prmS2y*pow(u, 2);
    double Deltaubarprime_prmS2y = -4*a*a_prmS2y*pow(u, 3);
    ...
    double sigmacoeff_prmS2y = sigmacoeffTerm1_prmS2y + sigmacoeffTerm2_prmS2y;
    ...
    double Heff_prmS2y = -Hd_prmS2y + Hns_prmS2y + Hs_prmS2y + 2*S2y*dSS*eta*pow(u, 4);
...
double ham_S2z_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double lambdahat_dot_Skerrhat_prmS2z = Skerrhat1_prmS2z*lambdahat1 + Skerrhat2_prmS2z*lambdahat2 + Skerrhat3_prmS2z*lambdahat3;
    double lambdahat_cross_Skerrhat3_prmS2z = -Skerrhat1_prmS2z*lambdahat2 + Skerrhat2_prmS2z*lambdahat1;
    double lambdahat_cross_Skerrhat2_prmS2z = Skerrhat1_prmS2z*lambdahat3 - Skerrhat3_prmS2z*lambdahat1;
    double lambdahat_cross_Skerrhat1_prmS2z = -Skerrhat2_prmS2z*lambdahat3 + Skerrhat3_prmS2z*lambdahat2;
    double Skerrhat_dot_n_prmS2z = Skerrhat1_prmS2z*n1 + Skerrhat2_prmS2z*n2 + Skerrhat3_prmS2z*n3;
    double condition_lhs_prmS2z = -Skerrhat_dot_n_prmS2z*(((Skerrhat_dot_n) > 0) - ((Skerrhat_dot_n) < 0));
    double greaterthan_bound_prmS2z = -condition_lhs_prmS2z*((1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs + (1.0/2.0)*fabs(condition_lhs - condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS2z*(((condition_lhs - condition_rhs) > 0) - ((condition_lhs - condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS2z)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double lesserthan_equal_bound_prmS2z = -condition_lhs_prmS2z*(-1.0/2.0*TINYDOUBLE + (1.0/2.0)*condition_lhs - 1.0/2.0*condition_rhs - 1.0/2.0*fabs(TINYDOUBLE - condition_lhs + condition_rhs))/pow(-TINYDOUBLE + condition_lhs - condition_rhs, 2) + ((1.0/2.0)*condition_lhs_prmS2z*(((TINYDOUBLE - condition_lhs + condition_rhs) > 0) - ((TINYDOUBLE - condition_lhs + condition_rhs) < 0)) + (1.0/2.0)*condition_lhs_prmS2z)/(-TINYDOUBLE + condition_lhs - condition_rhs);
    double e31_prmS2z = Skerrhat1*greaterthan_bound_prmS2z + Skerrhat1_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2z*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2z*sin_0_1_deg) + lesserthan_equal_bound_prmS2z*(Skerrhat1*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1*sin_0_1_deg);
    double e32_prmS2z = Skerrhat2*greaterthan_bound_prmS2z + Skerrhat2_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2z*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2z*sin_0_1_deg) + lesserthan_equal_bound_prmS2z*(Skerrhat2*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2*sin_0_1_deg);
    double e33_prmS2z = Skerrhat3*greaterthan_bound_prmS2z + Skerrhat3_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2z*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2z*sin_0_1_deg) + lesserthan_equal_bound_prmS2z*(Skerrhat3*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3*sin_0_1_deg);
    ...
    double Delta2_prmS2z = -2*Delta0*a*a_prmS2z*pow(etaKminus1, 2);
    double Delta3_prmS2z = Delta1*Delta2_prmS2z - 2*Delta1*a*a_prmS2z*pow(etaKminus1, 2) - 2*Delta2_prmS2z*etaKminus1;
    double Delta4_prmS2z = -pow(Delta1, 2)*Delta2_prmS2z + Delta1*(2*Delta2_prmS2z*etaKminus1 + Delta3_prmS2z) + Delta2*Delta2_prmS2z - Delta2_prmS2z*pow(a, 2)*pow(etaKminus1, 2) - 2*Delta3_prmS2z*etaKminus1 + a*a_prmS2z*pow(etaKminus1, 2)*(pow(Delta1, 2) - 2*Delta2);
    double Delta5_prmS2z = pow(etaKminus1, 2)*(-1.0/3.0*pow(a, 2)*(-3*Delta1*Delta2_prmS2z + 3*Delta3_prmS2z) + (1.0/3.0)*a*a_prmS2z*(-2*pow(Delta1, 3) + 6*Delta1*Delta2 - 6*Delta3) + (1.0/2.0)*(-4*pow(Delta1, 2)*Delta2_prmS2z + 4*Delta1*Delta3_prmS2z + 4*Delta2*Delta2_prmS2z - 4*Delta4_prmS2z)/etaKminus1 - 1.0/5.0*(-5*pow(Delta1, 3)*Delta2_prmS2z + 5*pow(Delta1, 2)*Delta3_prmS2z + 10*Delta1*Delta2*Delta2_prmS2z - 5*Delta1*Delta4_prmS2z - 5*Delta2*Delta3_prmS2z - 5*Delta2_prmS2z*Delta3)/pow(etaKminus1, 2));
    double logarg_prmS2z = pow(u, 2)*(Delta2_prmS2z + u*(Delta3_prmS2z + u*(Delta4_prmS2z + Delta5_prmS2z*u)));
    double Deltaucalib_prmS2z = eta*logarg_prmS2z*(((logarg + 1) > 0) - ((logarg + 1) < 0))/fabs(logarg + 1);
    double Deltaucalibprime_prmS2z = eta*logarg_prmS2z*pow(u, 2)*(Delta1 + u*(2*Delta2 + u*(3*Delta3 + u*(4*Delta4 + u*(5*Delta5 + 5*Delta5l*log(u))))))/pow(logarg + 1, 2) - eta*pow(u, 3)*(2*Delta2_prmS2z + u*(3*Delta3_prmS2z + u*(4*Delta4_prmS2z + 5*Delta5_prmS2z*u)))/(logarg + 1);
    double Deltaubar_prmS2z = 2*a*a_prmS2z*pow(u, 2);
    double Deltaubarprime_prmS2z = -4*a*a_prmS2z*pow(u, 3);
    ...
    double sigmacoeff_prmS2z = sigmacoeffTerm1_prmS2z + sigmacoeffTerm2_prmS2z;
    ...
    double Heff_prmS2z = -Hd_prmS2z + Hns_prmS2z + Hs_prmS2z + 2*S2z*dSS*eta*pow(u, 4);
