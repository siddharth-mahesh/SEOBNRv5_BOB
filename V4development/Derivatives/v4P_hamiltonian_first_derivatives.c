...
double ham_x_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmx = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat1_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmx*sin_0_1_deg);
    double e32_prmx = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat2_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmx*sin_0_1_deg);
    double e33_prmx = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmx*(1 - cos_0_1_deg) + lambdahat3_prmx*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmx*sin_0_1_deg);
...
double ham_y_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmy = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat1_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmy*sin_0_1_deg);
    double e32_prmy = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat2_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmy*sin_0_1_deg);
    double e33_prmy = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmy*(1 - cos_0_1_deg) + lambdahat3_prmy*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmy*sin_0_1_deg);
...
double ham_z_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmz = lesserthan_equal_bound*(lambdahat1*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat1_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmz*sin_0_1_deg);
    double e32_prmz = lesserthan_equal_bound*(lambdahat2*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat2_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmz*sin_0_1_deg);
    double e33_prmz = lesserthan_equal_bound*(lambdahat3*lambdahat_dot_Skerrhat_prmz*(1 - cos_0_1_deg) + lambdahat3_prmz*lambdahat_dot_Skerrhat*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmz*sin_0_1_deg);
...
double ham_S1x_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmS1x = Skerrhat1_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1x*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1x*sin_0_1_deg);
    double e32_prmS1x = Skerrhat2_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1x*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1x*sin_0_1_deg);
    double e33_prmS1x = Skerrhat3_prmS1x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1x*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1x*sin_0_1_deg);
...
double ham_S1y_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmS1y = Skerrhat1_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1y*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1y*sin_0_1_deg);
    double e32_prmS1y = Skerrhat2_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1y*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1y*sin_0_1_deg);
    double e33_prmS1y = Skerrhat3_prmS1y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1y*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1y*sin_0_1_deg);
...
double ham_S1z_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmS1z = Skerrhat1_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS1z*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS1z*sin_0_1_deg);
    double e32_prmS1z = Skerrhat2_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS1z*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS1z*sin_0_1_deg);
    double e33_prmS1z = Skerrhat3_prmS1z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS1z*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS1z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS1z*sin_0_1_deg);
...
double ham_S2x_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmS2x = Skerrhat1_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2x*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2x*sin_0_1_deg);
    double e32_prmS2x = Skerrhat2_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2x*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2x*sin_0_1_deg);
    double e33_prmS2x = Skerrhat3_prmS2x*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2x*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2x*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2x*sin_0_1_deg);
...
double ham_S2y_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmS2y = Skerrhat1_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2y*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2y*sin_0_1_deg);
    double e32_prmS2y = Skerrhat2_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2y*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2y*sin_0_1_deg);
    double e33_prmS2y = Skerrhat3_prmS2y*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2y*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2y*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2y*sin_0_1_deg);
...
double ham_S2z_deriv(double m1,double m2,int tortoise,double x,double y,double z,double p1,double p2,double p3,double S1x,double S1y,double S1z,double S2x,double S2y,double S2z){
    ...
    double e31_prmS2z = Skerrhat1_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat1_prmS2z*cos_0_1_deg + lambdahat1*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat1_prmS2z*sin_0_1_deg);
    double e32_prmS2z = Skerrhat2_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat2_prmS2z*cos_0_1_deg + lambdahat2*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat2_prmS2z*sin_0_1_deg);
    double e33_prmS2z = Skerrhat3_prmS2z*greaterthan_bound + lesserthan_equal_bound*(Skerrhat3_prmS2z*cos_0_1_deg + lambdahat3*lambdahat_dot_Skerrhat_prmS2z*(1 - cos_0_1_deg) + lambdahat_cross_Skerrhat3_prmS2z*sin_0_1_deg);
