import sympy as sp
import sys,os
sys.path.append('C:/Users/sidmahesh/OneDrive/Documents/GitHub/bob/')
...
def gen_v4popt_ham():
    ...
    return outputC(Hreal,"Hreal",filename='C:/Users/sidmahesh/OneDrive/Documents/GitHub/bob/V4development/Hamiltonian/v4popt_ham.c',params="includebraces=False,preindent=2,outCverbose=False,declareoutputvars=True,GoldenKernelsEnable=False")
