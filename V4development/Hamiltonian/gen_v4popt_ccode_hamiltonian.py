...
def gen_v4popt_ham():
    ...
    e3prov_gt_bound = sp.Rational(1,2)*(condition_e3prov_lhs - condition_e3prov_rhs + nrpyAbs(condition_e3prov_lhs - condition_e3prov_rhs))/(condition_e3prov_lhs - condition_e3prov_rhs - TINYDOUBLE)
    e3prov_leq_bound = sp.Rational(1,2)*(condition_e3prov_lhs - condition_e3prov_rhs - TINYDOUBLE - nrpyAbs(condition_e3prov_lhs - condition_e3prov_rhs - TINYDOUBLE))/(condition_e3prov_lhs - condition_e3prov_rhs - TINYDOUBLE)
    e3prov1 = Skerrhat1*e3prov_gt_bound + e3prov_leq_bound/sp.sqrt(3.)
    e3prov2 = Skerrhat2*e3prov_gt_bound + e3prov_leq_bound/sp.sqrt(3.)
    e3prov3 = Skerrhat3*e3prov_gt_bound + e3prov_leq_bound/sp.sqrt(3.)
    ...
    condition_e3_lhs = 1 - nrpyAbs(e3prov_dot_n)
    condition_e3_rhs = 1e-8
    e3_gt_bound = sp.Rational(1,2)*(condition_e3_lhs - condition_e3_rhs + nrpyAbs(condition_e3_lhs - condition_e3_rhs))/(condition_e3_lhs - condition_e3_rhs - TINYDOUBLE)
    e3_leq_bound = sp.Rational(1,2)*(condition_e3_lhs - condition_e3_rhs - TINYDOUBLE - nrpyAbs(condition_e3_lhs - condition_e3_rhs - TINYDOUBLE))/(condition_e3_lhs - condition_e3_rhs - TINYDOUBLE)
    ...
    return outputC(Hreal,"Hreal",filename="returnstring",params="CSE_sorting=none,includebraces=False,preindent=2,outCverbose=False,declareoutputvars=True,GoldenKernelsEnable=False")