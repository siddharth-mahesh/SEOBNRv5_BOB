...
def output_H_and_derivs():
    ...
    f = open("Schwarzschild/SymPy_Hreal_Cart_on_bottom.txt", 'r')
...
#
    ...
    with open("Playground_Pycodes/new_dHdx.py", "w") as file:
...
""")
    ...
    with open("Playground_Pycodes/new_dHdp2.py", "w") as file:
        file.write("""from __future__ import division
import numpy as np
...
""")
    ...
    with open("Playground_Pycodes/new_dHdp3.py", "w") as file:
        file.write("""from __future__ import division
import numpy as np
...
""")
    ...
    with open("Playground_Pycodes/dHdx.txt", "w") as file:
        for i in range(len(lr)):
