...
def ham_first_derivs(m1, m2, q1, q2, q3, p1, p2, p3):
    ...
    nprime3_prmq1 = qprime3*uprime_prmq1 + qprime3_prmq1*uprime
    nprime3_prmq2 = qprime3*uprime_prmq2 + qprime3_prmq2*uprime
    nprime3_prmq3 = qprime3*uprime_prmq3 + qprime3_prmq3*uprime
    nprime3_prmp1 = qprime3*uprime_prmp1 + qprime3_prmp1*uprime
    nprime3_prmp2 = qprime3*uprime_prmp2 + qprime3_prmp2*uprime
    nprime3_prmp3 = qprime3*uprime_prmp3 + qprime3_prmp3*uprime
    nprime2_prmq1 = qprime2*uprime_prmq1 + qprime2_prmq1*uprime
    nprime2_prmq2 = qprime2*uprime_prmq2 + qprime2_prmq2*uprime
    nprime2_prmq3 = qprime2*uprime_prmq3 + qprime2_prmq3*uprime
    nprime2_prmp1 = qprime2*uprime_prmp1 + qprime2_prmp1*uprime
    nprime2_prmp2 = qprime2*uprime_prmp2 + qprime2_prmp2*uprime
    nprime2_prmp3 = qprime2*uprime_prmp3 + qprime2_prmp3*uprime
    nprime1_prmq1 = qprime1*uprime_prmq1 + qprime1_prmq1*uprime
    nprime1_prmq2 = qprime1*uprime_prmq2 + qprime1_prmq2*uprime
    nprime1_prmq3 = qprime1*uprime_prmq3 + qprime1_prmq3*uprime
    nprime1_prmp1 = qprime1*uprime_prmp1 + qprime1_prmp1*uprime
    nprime1_prmp2 = qprime1*uprime_prmp2 + qprime1_prmp2*uprime
    nprime1_prmp3 = qprime1*uprime_prmp3 + qprime1_prmp3*uprime
