...
def compute_d2Hdxdp3(m1, m2, EMgamma, tortoise, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z):
    ...
    Dinv_x = (3*eta*u**2*u_x*(52-6*eta)+12*eta*u*u_x)/(eta*u**3*(52-6*eta)+6*eta*u**2+1)
    ...
    csi1_x = csi_x*(1-abs(1-tortoise))
    csi2_x = csi_x*(1/2-np.sign(3/2-tortoise)/2)
    ...
    Brtilde_x = (np.sqrt(Deltar)*Deltatprime_x-2*Deltat_x+Deltar_x*Deltatprime/(2*np.sqrt(Deltar)))/(2*np.sqrt(Deltar*Deltat))+(np.sqrt(Deltar)*Deltatprime-2*Deltat)*(-Deltar*Deltat_x/2-Deltar_x*Deltat/2)/(2*Deltar*Deltat*np.sqrt(Deltar*Deltat))
    ...
    Lambtprime_x = -2*Deltatprime*a**2*sin2theta_x-2*Deltatprime_x*a**2*sin2theta+8*r**2*r_x+r_x*(4*a**2+4*r**2)
    ...
    nur_x = r_x/Sigma-Sigma_x*r/Sigma**2+w2*(-4*Deltat*r_x+Deltatprime*w2_x+Deltatprime_x*w2-4*Deltat_x*r)/(2*Deltat*Lambt)+w2_x*(-4*Deltat*r+Deltatprime*w2)/(2*Deltat*Lambt)-Lambt_x*w2*(-4*Deltat*r+Deltatprime*w2)/(2*Deltat*Lambt**2)-Deltat_x*w2*(-4*Deltat*r+Deltatprime*w2)/(2*Deltat**2*Lambt)
    omegar_x = (-Lambtprime*omegatilde_x-Lambtprime_x*omegatilde+Lambt_x*omegatildeprime)/Lambt**2+Lambt_x*(-2*Lambt*omegatildeprime+2*Lambtprime*omegatilde)/Lambt**3
    ...
    Q4_x = 4*eta*prT**4*u*u_x*(4-3*eta)+8*eta*prT**3*prT_x*u**2*(4-3*eta)
    ...
    prT_xprm_p3 = csi2*n3_x + csi2_x*n3
    phat3_xprm_p3 = n3*prT_xprm_p3*(1 - 1/csi1) + n3_x*prTprm_p3*(1 - 1/csi1) + csi1_x*n3*prTprm_p3/csi1**2
    phat2_xprm_p3 = n2*prT_xprm_p3*(1 - 1/csi1) + n2_x*prTprm_p3*(1 - 1/csi1) + csi1_x*n2*prTprm_p3/csi1**2
    phat1_xprm_p3 = n1*prT_xprm_p3*(1 - 1/csi1) + n1_x*prTprm_p3*(1 - 1/csi1) + csi1_x*n1*prTprm_p3/csi1**2
    pdotxir_xprm_p3 = r*(phat1_xprm_p3*xi1 + phat1prm_p3*xi1_x + phat2_xprm_p3*xi2 + phat2prm_p3*xi2_x + phat3_xprm_p3*xi3 + phat3prm_p3*xi3_x) + r_x*(phat1prm_p3*xi1 + phat2prm_p3*xi2 + phat3prm_p3*xi3)
    pdotn_xprm_p3 = n1*phat1_xprm_p3 + n1_x*phat1prm_p3 + n2*phat2_xprm_p3 + n2_x*phat2prm_p3 + n3*phat3_xprm_p3 + n3_x*phat3prm_p3
    pdotvr_xprm_p3 = r*(phat1_xprm_p3*v1 + phat1prm_p3*v1_x + phat2_xprm_p3*v2 + phat2prm_p3*v2_x + phat3_xprm_p3*v3 + phat3prm_p3*v3_x) + r_x*(phat1prm_p3*v1 + phat2prm_p3*v2 + phat3prm_p3*v3)
    pphi_xprm_p3 = pdotxir_xprm_p3
    DrSipn2_xprm_p3 = 2*Deltar*pdotn*pdotn_xprm_p3/Sigma + 2*Deltar*pdotn_x*pdotnprm_p3/Sigma - 2*Deltar*Sigma_x*pdotn*pdotnprm_p3/Sigma**2 + 2*Deltar_x*pdotn*pdotnprm_p3/Sigma
    Q_xprm_p3 = DrSipn2_xprm_p3 + 2*Qcoeff1*pdotxir*pdotxir_xprm_p3 + 2*Qcoeff1*pdotxir_x*pdotxirprm_p3 + 2*Qcoeff1_x*pdotxir*pdotxirprm_p3 + 2*Qcoeff2*pdotvr*pdotvr_xprm_p3 + 2*Qcoeff2*pdotvr_x*pdotvrprm_p3 + 2*Qcoeff2_x*pdotvr*pdotvrprm_p3
    Qminus1_xprm_p3 = Q_xprm_p3
    sigmacoeffTerm2_xprm_p3 = eta*(eta*(r*(-882*DrSipn2_xprm_p3 + 204*Qminus1_xprm_p3 + r*(1620*DrSipn2*DrSipn2_xprm_p3 - 234*DrSipn2*Qminus1_xprm_p3 + 1620*DrSipn2_x*DrSipn2prm_p3 - 234*DrSipn2_x*Qminus1prm_p3 - 234*DrSipn2_xprm_p3*Qminus1 - 234*DrSipn2prm_p3*Qminus1_x) + r_x*(1620*DrSipn2*DrSipn2prm_p3 - 234*DrSipn2*Qminus1prm_p3 - 234*DrSipn2prm_p3*Qminus1)) + r_x*(-882*DrSipn2prm_p3 + 204*Qminus1prm_p3 + r*(1620*DrSipn2*DrSipn2prm_p3 - 234*DrSipn2*Qminus1prm_p3 - 234*DrSipn2prm_p3*Qminus1))) + r*(-96*DrSipn2_xprm_p3 - 436*Qminus1_xprm_p3 + r*(36*DrSipn2*Qminus1_xprm_p3 + 36*DrSipn2_x*Qminus1prm_p3 + 36*DrSipn2_xprm_p3*Qminus1 + 36*DrSipn2prm_p3*Qminus1_x - 90*Qminus1*Qminus1_xprm_p3 - 90*Qminus1_x*Qminus1prm_p3) + r_x*(36*DrSipn2*Qminus1prm_p3 + 36*DrSipn2prm_p3*Qminus1 - 90*Qminus1*Qminus1prm_p3)) + r_x*(-96*DrSipn2prm_p3 - 436*Qminus1prm_p3 + r*(36*DrSipn2*Qminus1prm_p3 + 36*DrSipn2prm_p3*Qminus1 - 90*Qminus1*Qminus1prm_p3)))/(144*r**2) - eta*r_x*(eta*r*(-882*DrSipn2prm_p3 + 204*Qminus1prm_p3 + r*(1620*DrSipn2*DrSipn2prm_p3 - 234*DrSipn2*Qminus1prm_p3 - 234*DrSipn2prm_p3*Qminus1)) + r*(-96*DrSipn2prm_p3 - 436*Qminus1prm_p3 + r*(36*DrSipn2*Qminus1prm_p3 + 36*DrSipn2prm_p3*Qminus1 - 90*Qminus1*Qminus1prm_p3)))/(72*r**3)
    sigmacoeffTerm1_xprm_p3 = eta*(-36*DrSipn2_xprm_p3 + 3*Qminus1_xprm_p3)/12
    sigmacoeff_xprm_p3 = sigmacoeffTerm1_xprm_p3 + sigmacoeffTerm2_xprm_p3
    sigmastarcoeffTerm2_xprm_p3 = eta*(eta*(r*(-324*DrSipn2_xprm_p3 + 120*Qminus1_xprm_p3 + r*(720*DrSipn2*DrSipn2_xprm_p3 + 720*DrSipn2_x*DrSipn2prm_p3 + Qminus1*(-126*DrSipn2_xprm_p3 - 3*Qminus1_xprm_p3) + Qminus1_x*(-126*DrSipn2prm_p3 - 3*Qminus1prm_p3) + Qminus1_xprm_p3*(-126*DrSipn2 - 3*Qminus1) + Qminus1prm_p3*(-126*DrSipn2_x - 3*Qminus1_x)) + r_x*(720*DrSipn2*DrSipn2prm_p3 + Qminus1*(-126*DrSipn2prm_p3 - 3*Qminus1prm_p3) + Qminus1prm_p3*(-126*DrSipn2 - 3*Qminus1))) + r_x*(-324*DrSipn2prm_p3 + 120*Qminus1prm_p3 + r*(720*DrSipn2*DrSipn2prm_p3 + Qminus1*(-126*DrSipn2prm_p3 - 3*Qminus1prm_p3) + Qminus1prm_p3*(-126*DrSipn2 - 3*Qminus1)))) + r*(282*DrSipn2_xprm_p3 + Qminus1*r*(96*DrSipn2_xprm_p3 - 23*Qminus1_xprm_p3) + Qminus1*r_x*(96*DrSipn2prm_p3 - 23*Qminus1prm_p3) + Qminus1_x*r*(96*DrSipn2prm_p3 - 23*Qminus1prm_p3) + Qminus1_xprm_p3*r*(96*DrSipn2 - 23*Qminus1) - 206*Qminus1_xprm_p3 + Qminus1prm_p3*r*(96*DrSipn2_x - 23*Qminus1_x) + Qminus1prm_p3*r_x*(96*DrSipn2 - 23*Qminus1)) + r_x*(282*DrSipn2prm_p3 + Qminus1*r*(96*DrSipn2prm_p3 - 23*Qminus1prm_p3) + Qminus1prm_p3*r*(96*DrSipn2 - 23*Qminus1) - 206*Qminus1prm_p3))/(72*r**2) - eta*r_x*(eta*r*(-324*DrSipn2prm_p3 + 120*Qminus1prm_p3 + r*(720*DrSipn2*DrSipn2prm_p3 + Qminus1*(-126*DrSipn2prm_p3 - 3*Qminus1prm_p3) + Qminus1prm_p3*(-126*DrSipn2 - 3*Qminus1))) + r*(282*DrSipn2prm_p3 + Qminus1*r*(96*DrSipn2prm_p3 - 23*Qminus1prm_p3) + Qminus1prm_p3*r*(96*DrSipn2 - 23*Qminus1) - 206*Qminus1prm_p3))/(36*r**3)
    sigmastarcoeffTerm1_xprm_p3 = eta*(-30*DrSipn2_xprm_p3 + 4*Qminus1_xprm_p3)/12
    sigmastarcoeff_xprm_p3 = sigmastarcoeffTerm1_xprm_p3 + sigmastarcoeffTerm2_xprm_p3
    Deltasigmastar3_xprm_p3 = sigma3*sigmacoeff_xprm_p3 + sigmastar3*sigmastarcoeff_xprm_p3
    Deltasigmastar2_xprm_p3 = sigma2*sigmacoeff_xprm_p3 + sigmastar2*sigmastarcoeff_xprm_p3
    Deltasigmastar1_xprm_p3 = sigma1*sigmacoeff_xprm_p3 + sigmastar1*sigmastarcoeff_xprm_p3
    Sstar3_xprm_p3 = Deltasigmastar3_xprm_p3
    Sstar2_xprm_p3 = Deltasigmastar2_xprm_p3
    Sstar1_xprm_p3 = Deltasigmastar1_xprm_p3
    S3_xprm_p3 = Sstar3_xprm_p3
    S2_xprm_p3 = Sstar2_xprm_p3
    S1_xprm_p3 = Sstar1_xprm_p3
    Sstardotn_xprm_p3 = Sstar1_xprm_p3*n1 + Sstar1prm_p3*n1_x + Sstar2_xprm_p3*n2 + Sstar2prm_p3*n2_x + Sstar3_xprm_p3*n3 + Sstar3prm_p3*n3_x
    SdotSkerrhat_xprm_p3 = S1_xprm_p3*Skerrhat1 + S2_xprm_p3*Skerrhat2 + S3_xprm_p3*Skerrhat3
    Sdotn_xprm_p3 = S1_xprm_p3*n1 + S1prm_p3*n1_x + S2_xprm_p3*n2 + S2prm_p3*n2_x + S3_xprm_p3*n3 + S3prm_p3*n3_x
    Sdotv_xprm_p3 = S1_xprm_p3*v1 + S1prm_p3*v1_x + S2_xprm_p3*v2 + S2prm_p3*v2_x + S3_xprm_p3*v3 + S3prm_p3*v3_x
    Sdotxi_xprm_p3 = S1_xprm_p3*xi1 + S1prm_p3*xi1_x + S2_xprm_p3*xi2 + S2prm_p3*xi2_x + S3_xprm_p3*xi3 + S3prm_p3*xi3_x
    HdsumTerm2_xprm_p3 = 6*Sstardotn*Sstardotn_xprm_p3 + 6*Sstardotn_x*Sstardotnprm_p3
    HdsumTerm1_xprm_p3 = 2*Sstar1*Sstar1_xprm_p3 + 2*Sstar1_x*Sstar1prm_p3 + 2*Sstar2*Sstar2_xprm_p3 + 2*Sstar2_x*Sstar2prm_p3 + 2*Sstar3*Sstar3_xprm_p3 + 2*Sstar3_x*Sstar3prm_p3
    Hdsum_xprm_p3 = HdsumTerm1_xprm_p3 - HdsumTerm2_xprm_p3
    Q4_xprm_p3 = 8*eta*prT**3*prT_xprm_p3*u**2*(4 - 3*eta) + 16*eta*prT**3*prTprm_p3*u*u_x*(4 - 3*eta) + 24*eta*prT**2*prT_x*prTprm_p3*u**2*(4 - 3*eta)
    gammappsum_xprm_p3 = 2*Deltar*pdotn*pdotn_xprm_p3/Sigma + 2*Deltar*pdotn_x*pdotnprm_p3/Sigma - 2*Deltar*Sigma_x*pdotn*pdotnprm_p3/Sigma**2 + 2*Deltar_x*pdotn*pdotnprm_p3/Sigma + 2*pdotvr*pdotvr_xprm_p3/(Sigma*sin2theta) - 2*pdotvr*pdotvrprm_p3*sin2theta_x/(Sigma*sin2theta**2) + 2*pdotvr_x*pdotvrprm_p3/(Sigma*sin2theta) - 2*Sigma_x*pdotvr*pdotvrprm_p3/(Sigma**2*sin2theta) + 2*Sigma*pdotxir*pdotxir_xprm_p3/(Lambt*sin2theta) - 2*Sigma*pdotxir*pdotxirprm_p3*sin2theta_x/(Lambt*sin2theta**2) + 2*Sigma*pdotxir_x*pdotxirprm_p3/(Lambt*sin2theta) + 2*Sigma_x*pdotxir*pdotxirprm_p3/(Lambt*sin2theta) - 2*Lambt_x*Sigma*pdotxir*pdotxirprm_p3/(Lambt**2*sin2theta)
    Hnsradicand_xprm_p3 = Q4_xprm_p3 + gammappsum_xprm_p3
    betapsum_xprm_p3 = omegatilde*pphi_xprm_p3/Lambt + omegatilde_x*pphiprm_p3/Lambt - Lambt_x*omegatilde*pphiprm_p3/Lambt**2
    HssTerm3_xprm_p3 = Btilde**2*(Sdotn*exp2mu*xisq*(-Q_xprm_p3 - Q_xprm_p3/(2*np.sqrt(Q)) + Q_x*Qprm_p3/(4*Q**(3/2))) + Sdotn*exp2mu*xisq_x*(-Qprm_p3 - Qprm_p3/(2*np.sqrt(Q))) + Sdotn*exp2mu_x*xisq*(-Qprm_p3 - Qprm_p3/(2*np.sqrt(Q))) + Sdotn_x*exp2mu*xisq*(-Qprm_p3 - Qprm_p3/(2*np.sqrt(Q))) + Sdotn_xprm_p3*exp2mu*xisq*(-np.sqrt(Q) - Q) + Sdotnprm_p3*exp2mu*xisq*(-Q_x - Q_x/(2*np.sqrt(Q))) + Sdotnprm_p3*exp2mu*xisq_x*(-np.sqrt(Q) - Q) + Sdotnprm_p3*exp2mu_x*xisq*(-np.sqrt(Q) - Q) + pdotvr*(-Jtilde*Sdotv*pdotn_xprm_p3 - Jtilde*Sdotv_x*pdotnprm_p3 - Jtilde*Sdotv_xprm_p3*pdotn - Jtilde*Sdotvprm_p3*pdotn_x - Jtilde_x*Sdotv*pdotnprm_p3 - Jtilde_x*Sdotvprm_p3*pdotn + Sdotn*pdotvr_xprm_p3 + Sdotn_x*pdotvrprm_p3 + Sdotn_xprm_p3*pdotvr + Sdotnprm_p3*pdotvr_x) + pdotvr_x*(-Jtilde*Sdotv*pdotnprm_p3 - Jtilde*Sdotvprm_p3*pdotn + Sdotn*pdotvrprm_p3 + Sdotnprm_p3*pdotvr) + pdotvr_xprm_p3*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + pdotvrprm_p3*(-Jtilde*Sdotv*pdotn_x - Jtilde*Sdotv_x*pdotn - Jtilde_x*Sdotv*pdotn + Sdotn*pdotvr_x + Sdotn_x*pdotvr)) + Btilde*Btilde_x*(Sdotn*exp2mu*xisq*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q)) + Sdotnprm_p3*exp2mu*xisq*(-2*np.sqrt(Q) - 2*Q) + pdotvr*(-2*Jtilde*Sdotv*pdotnprm_p3 - 2*Jtilde*Sdotvprm_p3*pdotn + 2*Sdotn*pdotvrprm_p3 + 2*Sdotnprm_p3*pdotvr) + pdotvrprm_p3*(-2*Jtilde*Sdotv*pdotn + 2*Sdotn*pdotvr)) + expmu*expnu*pdotxir*(Btilde*Jtilde*Sdotxi*pdotn_xprm_p3 + Btilde*Jtilde*Sdotxi_x*pdotnprm_p3 + Btilde*Jtilde*Sdotxi_xprm_p3*pdotn + Btilde*Jtilde*Sdotxiprm_p3*pdotn_x + Btilde*Jtilde_x*Sdotxi*pdotnprm_p3 + Btilde*Jtilde_x*Sdotxiprm_p3*pdotn + Btilde_x*Jtilde*Sdotxi*pdotnprm_p3 + Btilde_x*Jtilde*Sdotxiprm_p3*pdotn - Sdotn*expmu*expnu*pdotxir_xprm_p3 - Sdotn*expmu*expnu_x*pdotxirprm_p3 - Sdotn*expmu_x*expnu*pdotxirprm_p3 - Sdotn_x*expmu*expnu*pdotxirprm_p3 - Sdotn_xprm_p3*expmu*expnu*pdotxir - Sdotnprm_p3*expmu*expnu*pdotxir_x - Sdotnprm_p3*expmu*expnu_x*pdotxir - Sdotnprm_p3*expmu_x*expnu*pdotxir) + expmu*expnu*pdotxir_x*(Btilde*Jtilde*Sdotxi*pdotnprm_p3 + Btilde*Jtilde*Sdotxiprm_p3*pdotn - Sdotn*expmu*expnu*pdotxirprm_p3 - Sdotnprm_p3*expmu*expnu*pdotxir) + expmu*expnu*pdotxir_xprm_p3*(Btilde*Jtilde*Sdotxi*pdotn - Sdotn*expmu*expnu*pdotxir) + expmu*expnu*pdotxirprm_p3*(Btilde*Jtilde*Sdotxi*pdotn_x + Btilde*Jtilde*Sdotxi_x*pdotn + Btilde*Jtilde_x*Sdotxi*pdotn + Btilde_x*Jtilde*Sdotxi*pdotn - Sdotn*expmu*expnu*pdotxir_x - Sdotn*expmu*expnu_x*pdotxir - Sdotn*expmu_x*expnu*pdotxir - Sdotn_x*expmu*expnu*pdotxir) + expmu*expnu_x*pdotxir*(Btilde*Jtilde*Sdotxi*pdotnprm_p3 + Btilde*Jtilde*Sdotxiprm_p3*pdotn - Sdotn*expmu*expnu*pdotxirprm_p3 - Sdotnprm_p3*expmu*expnu*pdotxir) + expmu*expnu_x*pdotxirprm_p3*(Btilde*Jtilde*Sdotxi*pdotn - Sdotn*expmu*expnu*pdotxir) + expmu_x*expnu*pdotxir*(Btilde*Jtilde*Sdotxi*pdotnprm_p3 + Btilde*Jtilde*Sdotxiprm_p3*pdotn - Sdotn*expmu*expnu*pdotxirprm_p3 - Sdotnprm_p3*expmu*expnu*pdotxir) + expmu_x*expnu*pdotxirprm_p3*(Btilde*Jtilde*Sdotxi*pdotn - Sdotn*expmu*expnu*pdotxir)
    HssTerm3coeff_xprm_p3 = omegacostheta*(-Q_xprm_p3 - Q_xprm_p3/(2*np.sqrt(Q)) + Q_x*Qprm_p3/(4*Q**(3/2)))/(2*Btilde*exp2mu*expmu*expnu*(np.sqrt(Q) + Q)**2) + omegacostheta*(-Q_x - Q_x/(2*np.sqrt(Q)))*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(2*Btilde*exp2mu*expmu*expnu*(np.sqrt(Q) + Q)**3) + omegacostheta_x*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu*expnu*(2*np.sqrt(Q) + 2*Q)**2) - expnu_x*omegacostheta*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu*expnu**2*(2*np.sqrt(Q) + 2*Q)**2) - expmu_x*omegacostheta*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu**2*expnu*(2*np.sqrt(Q) + 2*Q)**2) - exp2mu_x*omegacostheta*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu**2*expmu*expnu*(2*np.sqrt(Q) + 2*Q)**2) - Btilde_x*omegacostheta*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde**2*exp2mu*expmu*expnu*(2*np.sqrt(Q) + 2*Q)**2)
    HssTerm2_xprm_p3 = Btilde**2*xisq*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotn_xprm_p3 - Jtilde*Sdotv_x*pdotnprm_p3 - Jtilde*Sdotv_xprm_p3*pdotn - Jtilde*Sdotvprm_p3*pdotn_x - Jtilde_x*Sdotv*pdotnprm_p3 - Jtilde_x*Sdotvprm_p3*pdotn + Sdotn*pdotvr_xprm_p3 + Sdotn_x*pdotvrprm_p3 + Sdotn_xprm_p3*pdotvr + Sdotnprm_p3*pdotvr_x) + Jtilde*pdotn_x*(-Jtilde*Sdotv*pdotnprm_p3 - Jtilde*Sdotvprm_p3*pdotn + Sdotn*pdotvrprm_p3 + Sdotnprm_p3*pdotvr) + Jtilde*pdotn_xprm_p3*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Jtilde*pdotnprm_p3*(-Jtilde*Sdotv*pdotn_x - Jtilde*Sdotv_x*pdotn - Jtilde_x*Sdotv*pdotn + Sdotn*pdotvr_x + Sdotn_x*pdotvr) + Jtilde_x*pdotn*(-Jtilde*Sdotv*pdotnprm_p3 - Jtilde*Sdotvprm_p3*pdotn + Sdotn*pdotvrprm_p3 + Sdotnprm_p3*pdotvr) + Jtilde_x*pdotnprm_p3*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(Q_xprm_p3 + Q_xprm_p3/(2*np.sqrt(Q)) - Q_x*Qprm_p3/(4*Q**(3/2))) + Sdotv*exp2mu_x*(Qprm_p3 + Qprm_p3/(2*np.sqrt(Q))) + Sdotv_x*exp2mu*(Qprm_p3 + Qprm_p3/(2*np.sqrt(Q))) + Sdotv_xprm_p3*exp2mu*(np.sqrt(Q) + Q) + Sdotvprm_p3*exp2mu*(Q_x + Q_x/(2*np.sqrt(Q))) + Sdotvprm_p3*exp2mu_x*(np.sqrt(Q) + Q)) + Btilde**2*xisq_x*(Jtilde*pdotn*(-Jtilde*Sdotv*pdotnprm_p3 - Jtilde*Sdotvprm_p3*pdotn + Sdotn*pdotvrprm_p3 + Sdotnprm_p3*pdotvr) + Jtilde*pdotnprm_p3*(-Jtilde*Sdotv*pdotn + Sdotn*pdotvr) + Sdotv*exp2mu*(Qprm_p3 + Qprm_p3/(2*np.sqrt(Q))) + Sdotvprm_p3*exp2mu*(np.sqrt(Q) + Q)) + Btilde*Btilde_x*xisq*(Jtilde*pdotn*(-2*Jtilde*Sdotv*pdotnprm_p3 - 2*Jtilde*Sdotvprm_p3*pdotn + 2*Sdotn*pdotvrprm_p3 + 2*Sdotnprm_p3*pdotvr) + Jtilde*pdotnprm_p3*(-2*Jtilde*Sdotv*pdotn + 2*Sdotn*pdotvr) + Sdotv*exp2mu*(2*Qprm_p3 + Qprm_p3/np.sqrt(Q)) + Sdotvprm_p3*exp2mu*(2*np.sqrt(Q) + 2*Q)) + expmu*pdotxir*(-Btilde*Sdotxi*expnu*pdotvr_xprm_p3 - Btilde*Sdotxi*expnu_x*pdotvrprm_p3 - Btilde*Sdotxi_x*expnu*pdotvrprm_p3 - Btilde*Sdotxi_xprm_p3*expnu*pdotvr - Btilde*Sdotxiprm_p3*expnu*pdotvr_x - Btilde*Sdotxiprm_p3*expnu_x*pdotvr - Btilde_x*Sdotxi*expnu*pdotvrprm_p3 - Btilde_x*Sdotxiprm_p3*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir_xprm_p3 + Sdotv*exp2nu*expmu_x*pdotxirprm_p3 + Sdotv*exp2nu_x*expmu*pdotxirprm_p3 + Sdotv_x*exp2nu*expmu*pdotxirprm_p3 + Sdotv_xprm_p3*exp2nu*expmu*pdotxir + Sdotvprm_p3*exp2nu*expmu*pdotxir_x + Sdotvprm_p3*exp2nu*expmu_x*pdotxir + Sdotvprm_p3*exp2nu_x*expmu*pdotxir) + expmu*pdotxir_x*(-Btilde*Sdotxi*expnu*pdotvrprm_p3 - Btilde*Sdotxiprm_p3*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxirprm_p3 + Sdotvprm_p3*exp2nu*expmu*pdotxir) + expmu*pdotxir_xprm_p3*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir) + expmu*pdotxirprm_p3*(-Btilde*Sdotxi*expnu*pdotvr_x - Btilde*Sdotxi*expnu_x*pdotvr - Btilde*Sdotxi_x*expnu*pdotvr - Btilde_x*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir_x + Sdotv*exp2nu*expmu_x*pdotxir + Sdotv*exp2nu_x*expmu*pdotxir + Sdotv_x*exp2nu*expmu*pdotxir) + expmu_x*pdotxir*(-Btilde*Sdotxi*expnu*pdotvrprm_p3 - Btilde*Sdotxiprm_p3*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxirprm_p3 + Sdotvprm_p3*exp2nu*expmu*pdotxir) + expmu_x*pdotxirprm_p3*(-Btilde*Sdotxi*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir)
    HssTerm2coeff_xprm_p3 = Jtilde*omegar*(-Q_xprm_p3 - Q_xprm_p3/(2*np.sqrt(Q)) + Q_x*Qprm_p3/(4*Q**(3/2)))/(2*Btilde*exp2mu*expmu*expnu*xisq*(np.sqrt(Q) + Q)**2) + Jtilde*omegar*(-Q_x - Q_x/(2*np.sqrt(Q)))*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(2*Btilde*exp2mu*expmu*expnu*xisq*(np.sqrt(Q) + Q)**3) - Jtilde*omegar*xisq_x*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu*expnu*xisq**2*(2*np.sqrt(Q) + 2*Q)**2) + Jtilde*omegar_x*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu*expnu*xisq*(2*np.sqrt(Q) + 2*Q)**2) - Jtilde*expnu_x*omegar*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu*expnu**2*xisq*(2*np.sqrt(Q) + 2*Q)**2) - Jtilde*expmu_x*omegar*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu**2*expnu*xisq*(2*np.sqrt(Q) + 2*Q)**2) - Jtilde*exp2mu_x*omegar*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu**2*expmu*expnu*xisq*(2*np.sqrt(Q) + 2*Q)**2) + Jtilde_x*omegar*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde*exp2mu*expmu*expnu*xisq*(2*np.sqrt(Q) + 2*Q)**2) - Btilde_x*Jtilde*omegar*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde**2*exp2mu*expmu*expnu*xisq*(2*np.sqrt(Q) + 2*Q)**2)
    HssTerm1_xprm_p3 = SdotSkerrhat_xprm_p3*omega + SdotSkerrhatprm_p3*omega_x
    Hss_xprm_p3 = HssTerm1_xprm_p3 + HssTerm2*HssTerm2coeff_xprm_p3 + HssTerm2_x*HssTerm2coeffprm_p3 + HssTerm2_xprm_p3*HssTerm2coeff + HssTerm2coeff_x*HssTerm2prm_p3 + HssTerm3*HssTerm3coeff_xprm_p3 + HssTerm3_x*HssTerm3coeffprm_p3 + HssTerm3_xprm_p3*HssTerm3coeff + HssTerm3coeff_x*HssTerm3prm_p3
    HsoTerm2c_xprm_p3 = Brtilde*Jtilde*Sdotv*expmu*expnu*pdotxir_xprm_p3*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv*expmu*expnu_x*pdotxirprm_p3*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv*expmu_x*expnu*pdotxirprm_p3*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv_x*expmu*expnu*pdotxirprm_p3*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv_xprm_p3*expmu*expnu*pdotxir*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotvprm_p3*expmu*expnu*pdotxir_x*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotvprm_p3*expmu*expnu_x*pdotxir*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotvprm_p3*expmu_x*expnu*pdotxir*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Q_x*Sdotv*expmu*expnu*pdotxirprm_p3/(2*np.sqrt(Q)) + Brtilde*Jtilde*Q_x*Sdotvprm_p3*expmu*expnu*pdotxir/(2*np.sqrt(Q)) + Brtilde*Jtilde*Q_xprm_p3*Sdotv*expmu*expnu*pdotxir/(2*np.sqrt(Q)) + Brtilde*Jtilde*Qprm_p3*Sdotv*expmu*expnu*pdotxir_x/(2*np.sqrt(Q)) + Brtilde*Jtilde*Qprm_p3*Sdotv*expmu*expnu_x*pdotxir/(2*np.sqrt(Q)) + Brtilde*Jtilde*Qprm_p3*Sdotv*expmu_x*expnu*pdotxir/(2*np.sqrt(Q)) + Brtilde*Jtilde*Qprm_p3*Sdotv_x*expmu*expnu*pdotxir/(2*np.sqrt(Q)) - Brtilde*Jtilde*Q_x*Qprm_p3*Sdotv*expmu*expnu*pdotxir/(4*Q**(3/2)) + Brtilde*Jtilde_x*Sdotv*expmu*expnu*pdotxirprm_p3*(np.sqrt(Q) + 1) + Brtilde*Jtilde_x*Sdotvprm_p3*expmu*expnu*pdotxir*(np.sqrt(Q) + 1) + Brtilde*Jtilde_x*Qprm_p3*Sdotv*expmu*expnu*pdotxir/(2*np.sqrt(Q)) + Brtilde_x*Jtilde*Sdotv*expmu*expnu*pdotxirprm_p3*(np.sqrt(Q) + 1) + Brtilde_x*Jtilde*Sdotvprm_p3*expmu*expnu*pdotxir*(np.sqrt(Q) + 1) + Brtilde_x*Jtilde*Qprm_p3*Sdotv*expmu*expnu*pdotxir/(2*np.sqrt(Q))
    HsoTerm2b_xprm_p3 = Btilde*expmu*expnu*pdotxir*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv_xprm_p3*nur + Jtilde*Sdotvprm_p3*nur_x + Jtilde_x*Sdotvprm_p3*nur - Sdotn_xprm_p3*nucostheta*xisq - Sdotnprm_p3*nucostheta*xisq_x - Sdotnprm_p3*nucostheta_x*xisq) + Btilde*expmu*expnu*pdotxir_x*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotvprm_p3*nur - Sdotnprm_p3*nucostheta*xisq) + Btilde*expmu*expnu*pdotxir_xprm_p3*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde*expmu*expnu*pdotxirprm_p3*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv*nur_x + Jtilde*Sdotv_x*nur + Jtilde_x*Sdotv*nur - Sdotn*nucostheta*xisq_x - Sdotn*nucostheta_x*xisq - Sdotn_x*nucostheta*xisq) + Btilde*expmu*expnu_x*pdotxir*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotvprm_p3*nur - Sdotnprm_p3*nucostheta*xisq) + Btilde*expmu*expnu_x*pdotxirprm_p3*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde*expmu_x*expnu*pdotxir*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotvprm_p3*nur - Sdotnprm_p3*nucostheta*xisq) + Btilde*expmu_x*expnu*pdotxirprm_p3*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde*Q_x*expmu*expnu*pdotxir*(Jtilde*Sdotvprm_p3*nur - Sdotnprm_p3*nucostheta*xisq)/np.sqrt(Q) + Btilde*Q_x*expmu*expnu*pdotxirprm_p3*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) + Btilde*Q_xprm_p3*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) + Btilde*Qprm_p3*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur_x + Jtilde*Sdotv_x*nur + Jtilde_x*Sdotv*nur - Sdotn*nucostheta*xisq_x - Sdotn*nucostheta_x*xisq - Sdotn_x*nucostheta*xisq)/np.sqrt(Q) + Btilde*Qprm_p3*expmu*expnu*pdotxir_x*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) + Btilde*Qprm_p3*expmu*expnu_x*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) + Btilde*Qprm_p3*expmu_x*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) - Btilde*Q_x*Qprm_p3*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/(2*Q**(3/2)) + Btilde_x*expmu*expnu*pdotxir*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotvprm_p3*nur - Sdotnprm_p3*nucostheta*xisq) + Btilde_x*expmu*expnu*pdotxirprm_p3*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq) + Btilde_x*Qprm_p3*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q)
    HsoTerm2a_xprm_p3 = Btilde**2*Jtilde*Sdotxi*(-np.sqrt(Q)*(nur*pdotvr_xprm_p3 + nur_x*pdotvrprm_p3 + pdotn_xprm_p3*xisq*(mucostheta - nucostheta) + pdotnprm_p3*xisq*(mucostheta_x - nucostheta_x) + pdotnprm_p3*xisq_x*(mucostheta - nucostheta)) - mucostheta*pdotn_xprm_p3*xisq - mucostheta*pdotnprm_p3*xisq_x - mucostheta_x*pdotnprm_p3*xisq + mur*pdotvr_xprm_p3*(np.sqrt(Q) + 1) + mur_x*pdotvrprm_p3*(np.sqrt(Q) + 1) + Q_x*mur*pdotvrprm_p3/(2*np.sqrt(Q)) + Q_x*(-nur*pdotvrprm_p3 + pdotnprm_p3*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q)) + Q_xprm_p3*mur*pdotvr/(2*np.sqrt(Q)) + Q_xprm_p3*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q)) + Qprm_p3*mur*pdotvr_x/(2*np.sqrt(Q)) + Qprm_p3*mur_x*pdotvr/(2*np.sqrt(Q)) - Qprm_p3*(nur*pdotvr_x + nur_x*pdotvr + pdotn*xisq*(mucostheta_x - nucostheta_x) + pdotn*xisq_x*(mucostheta - nucostheta) + pdotn_x*xisq*(mucostheta - nucostheta))/(2*np.sqrt(Q)) - Q_x*Qprm_p3*mur*pdotvr/(4*Q**(3/2)) - Q_x*Qprm_p3*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(4*Q**(3/2))) + Btilde**2*Jtilde*Sdotxi_x*(np.sqrt(Q)*(-nur*pdotvrprm_p3 + pdotnprm_p3*xisq*(-mucostheta + nucostheta)) - mucostheta*pdotnprm_p3*xisq + mur*pdotvrprm_p3*(np.sqrt(Q) + 1) + Qprm_p3*mur*pdotvr/(2*np.sqrt(Q)) + Qprm_p3*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q))) + Btilde**2*Jtilde*Sdotxi_xprm_p3*(np.sqrt(Q)*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta)) - mucostheta*pdotn*xisq + mur*pdotvr*(np.sqrt(Q) + 1)) + Btilde**2*Jtilde*Sdotxiprm_p3*(-np.sqrt(Q)*(nur*pdotvr_x + nur_x*pdotvr + pdotn*xisq*(mucostheta_x - nucostheta_x) + pdotn*xisq_x*(mucostheta - nucostheta) + pdotn_x*xisq*(mucostheta - nucostheta)) - mucostheta*pdotn*xisq_x - mucostheta*pdotn_x*xisq - mucostheta_x*pdotn*xisq + mur*pdotvr_x*(np.sqrt(Q) + 1) + mur_x*pdotvr*(np.sqrt(Q) + 1) + Q_x*mur*pdotvr/(2*np.sqrt(Q)) + Q_x*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q))) + Btilde**2*Jtilde_x*Sdotxi*(np.sqrt(Q)*(-nur*pdotvrprm_p3 + pdotnprm_p3*xisq*(-mucostheta + nucostheta)) - mucostheta*pdotnprm_p3*xisq + mur*pdotvrprm_p3*(np.sqrt(Q) + 1) + Qprm_p3*mur*pdotvr/(2*np.sqrt(Q)) + Qprm_p3*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q))) + Btilde**2*Jtilde_x*Sdotxiprm_p3*(np.sqrt(Q)*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta)) - mucostheta*pdotn*xisq + mur*pdotvr*(np.sqrt(Q) + 1)) + Btilde*Btilde_x*Jtilde*Sdotxi*(np.sqrt(Q)*(-2*nur*pdotvrprm_p3 + 2*pdotnprm_p3*xisq*(-mucostheta + nucostheta)) - 2*mucostheta*pdotnprm_p3*xisq + mur*pdotvrprm_p3*(2*np.sqrt(Q) + 2) + Qprm_p3*mur*pdotvr/np.sqrt(Q) + Qprm_p3*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/np.sqrt(Q)) + Btilde*Btilde_x*Jtilde*Sdotxiprm_p3*(np.sqrt(Q)*(-2*nur*pdotvr + 2*pdotn*xisq*(-mucostheta + nucostheta)) - 2*mucostheta*pdotn*xisq + mur*pdotvr*(2*np.sqrt(Q) + 2))
    HsoTerm2_xprm_p3 = HsoTerm2a_xprm_p3 + HsoTerm2b_xprm_p3 - HsoTerm2c_xprm_p3
    HsoTerm2coeff_xprm_p3 = expnu*(-Q_xprm_p3 - Q_xprm_p3/(2*np.sqrt(Q)) + Q_x*Qprm_p3/(4*Q**(3/2)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) + expnu*(-Q_x - Q_x/(2*np.sqrt(Q)))*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**3) - expnu*xisq_x*(-Qprm_p3 - Qprm_p3/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq**2*(np.sqrt(Q) + Q)**2) + expnu_x*(-Qprm_p3 - Qprm_p3/(2*np.sqrt(Q)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) - exp2mu_x*expnu*(-Qprm_p3 - Qprm_p3/(2*np.sqrt(Q)))/(Btilde**2*exp2mu**2*xisq*(np.sqrt(Q) + Q)**2) - Btilde_x*expnu*(-2*Qprm_p3 - Qprm_p3/np.sqrt(Q))/(Btilde**3*exp2mu*xisq*(np.sqrt(Q) + Q)**2)
    HsoTerm1_xprm_p3 = SdotSkerrhat*exp2nu*pdotxir_xprm_p3*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxirprm_p3*(-Btilde_x + expmu*expnu_x + expmu_x*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat*exp2nu*pdotxirprm_p3*xisq_x*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) - SdotSkerrhat*exp2nu*expmu_x*pdotxirprm_p3*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhat*exp2nu_x*pdotxirprm_p3*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_x*exp2nu*pdotxirprm_p3*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_xprm_p3*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhatprm_p3*exp2nu*pdotxir*(-Btilde_x + expmu*expnu_x + expmu_x*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhatprm_p3*exp2nu*pdotxir*xisq_x*(Btilde - expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq**2) + SdotSkerrhatprm_p3*exp2nu*pdotxir_x*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - SdotSkerrhatprm_p3*exp2nu*expmu_x*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu**2*xisq) + SdotSkerrhatprm_p3*exp2nu_x*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_x*SdotSkerrhat*exp2nu*pdotxirprm_p3*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Q_x*SdotSkerrhatprm_p3*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Q_xprm_p3*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Qprm_p3*SdotSkerrhat*exp2nu*pdotxir*(-Btilde_x + expmu*expnu_x + expmu_x*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Qprm_p3*SdotSkerrhat*exp2nu*pdotxir*xisq_x*(Btilde - expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq**2) - Qprm_p3*SdotSkerrhat*exp2nu*pdotxir_x*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) + Qprm_p3*SdotSkerrhat*exp2nu*expmu_x*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu**2*xisq) - Qprm_p3*SdotSkerrhat*exp2nu_x*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Qprm_p3*SdotSkerrhat_x*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) + Q_x*Qprm_p3*SdotSkerrhat*exp2nu*pdotxir*(-3*Btilde + 3*expmu*expnu)/(4*Btilde**2*Q**(5/2)*expmu*xisq) - Btilde_x*SdotSkerrhat*exp2nu*pdotxirprm_p3*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq) - Btilde_x*SdotSkerrhatprm_p3*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(Btilde**3*np.sqrt(Q)*expmu*xisq) + Btilde_x*Qprm_p3*SdotSkerrhat*exp2nu*pdotxir*(-2*Btilde + 2*expmu*expnu)/(2*Btilde**3*Q**(3/2)*expmu*xisq)
    Hso_xprm_p3 = HsoTerm1_xprm_p3 + HsoTerm2*HsoTerm2coeff_xprm_p3 + HsoTerm2_x*HsoTerm2coeffprm_p3 + HsoTerm2_xprm_p3*HsoTerm2coeff + HsoTerm2coeff_x*HsoTerm2prm_p3
    Hd_xprm_p3 = Hdcoeff*Hdsum_xprm_p3 + Hdcoeff_x*Hdsumprm_p3
    Hns_xprm_p3 = betapsum_xprm_p3 + Hnsradicand_xprm_p3*alpha/(2*np.sqrt(Hnsradicand)) + Hnsradicandprm_p3*alpha_x/(2*np.sqrt(Hnsradicand)) - Hnsradicand_x*Hnsradicandprm_p3*alpha/(4*Hnsradicand**(3/2))
    Hs_xprm_p3 = Hso_xprm_p3 + Hss_xprm_p3
    Heff_xprm_p3 = -Hd_xprm_p3 + Hns_xprm_p3 + Hs_xprm_p3
    Hreal_xprm_p3 = -Heff_x*Heffprm_p3*eta**2/(2*eta*(Heff - 1) + 1)**(3/2) + Heff_xprm_p3*eta/np.sqrt(2*eta*(Heff - 1) + 1)
    return np.array([Hreal_xprm_p3])