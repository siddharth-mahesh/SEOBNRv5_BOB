...
def compute_d2Hdp22(m1, m2, eta, x, y, z, p1, p2, p3, S1x, S1y, S1z, S2x, S2y, S2z, KK, k0, k1, dSO, dSS, tortoise, EMgamma):
    ...
    DrSipn2_p2prm_p2 = 2*Deltar*pdotn_p2*pdotnprm_p2/Sigma
    Q_p2prm_p2 = DrSipn2_p2prm_p2 + 2*Qcoeff1*pdotxir_p2*pdotxirprm_p2 + 2*Qcoeff2*pdotvr_p2*pdotvrprm_p2
    Qminus1_p2prm_p2 = Q_p2prm_p2
    sigmacoeffTerm2_p2prm_p2 = eta*(eta*r*(-882*DrSipn2_p2prm_p2 + 204*Qminus1_p2prm_p2 + r*(1620*DrSipn2*DrSipn2_p2prm_p2 - 234*DrSipn2*Qminus1_p2prm_p2 + 1620*DrSipn2_p2*DrSipn2prm_p2 - 234*DrSipn2_p2*Qminus1prm_p2 - 234*DrSipn2_p2prm_p2*Qminus1 - 234*DrSipn2prm_p2*Qminus1_p2)) + r*(-96*DrSipn2_p2prm_p2 - 436*Qminus1_p2prm_p2 + r*(36*DrSipn2*Qminus1_p2prm_p2 + 36*DrSipn2_p2*Qminus1prm_p2 + 36*DrSipn2_p2prm_p2*Qminus1 + 36*DrSipn2prm_p2*Qminus1_p2 - 90*Qminus1*Qminus1_p2prm_p2 - 90*Qminus1_p2*Qminus1prm_p2)))/(144*r**2)
    sigmacoeffTerm1_p2prm_p2 = eta*(-36*DrSipn2_p2prm_p2 + 3*Qminus1_p2prm_p2)/12
    sigmacoeff_p2prm_p2 = sigmacoeffTerm1_p2prm_p2 + sigmacoeffTerm2_p2prm_p2
    sigmastarcoeffTerm2_p2prm_p2 = eta*(eta*r*(-324*DrSipn2_p2prm_p2 + 120*Qminus1_p2prm_p2 + r*(720*DrSipn2*DrSipn2_p2prm_p2 + 720*DrSipn2_p2*DrSipn2prm_p2 + Qminus1*(-126*DrSipn2_p2prm_p2 - 3*Qminus1_p2prm_p2) + Qminus1_p2*(-126*DrSipn2prm_p2 - 3*Qminus1prm_p2) + Qminus1_p2prm_p2*(-126*DrSipn2 - 3*Qminus1) + Qminus1prm_p2*(-126*DrSipn2_p2 - 3*Qminus1_p2))) + r*(282*DrSipn2_p2prm_p2 + Qminus1*r*(96*DrSipn2_p2prm_p2 - 23*Qminus1_p2prm_p2) + Qminus1_p2*r*(96*DrSipn2prm_p2 - 23*Qminus1prm_p2) + Qminus1_p2prm_p2*r*(96*DrSipn2 - 23*Qminus1) - 206*Qminus1_p2prm_p2 + Qminus1prm_p2*r*(96*DrSipn2_p2 - 23*Qminus1_p2)))/(72*r**2)
    sigmastarcoeffTerm1_p2prm_p2 = eta*(-30*DrSipn2_p2prm_p2 + 4*Qminus1_p2prm_p2)/12
    sigmastarcoeff_p2prm_p2 = sigmastarcoeffTerm1_p2prm_p2 + sigmastarcoeffTerm2_p2prm_p2
    Deltasigmastar3_p2prm_p2 = sigma3*sigmacoeff_p2prm_p2 + sigmastar3*sigmastarcoeff_p2prm_p2
    Deltasigmastar2_p2prm_p2 = sigma2*sigmacoeff_p2prm_p2 + sigmastar2*sigmastarcoeff_p2prm_p2
    Deltasigmastar1_p2prm_p2 = sigma1*sigmacoeff_p2prm_p2 + sigmastar1*sigmastarcoeff_p2prm_p2
    Sstar3_p2prm_p2 = Deltasigmastar3_p2prm_p2
    Sstar2_p2prm_p2 = Deltasigmastar2_p2prm_p2
    Sstar1_p2prm_p2 = Deltasigmastar1_p2prm_p2
    S3_p2prm_p2 = Sstar3_p2prm_p2
    S2_p2prm_p2 = Sstar2_p2prm_p2
    S1_p2prm_p2 = Sstar1_p2prm_p2
    Sstardotn_p2prm_p2 = Sstar1_p2prm_p2*n1 + Sstar2_p2prm_p2*n2 + Sstar3_p2prm_p2*n3
    SdotSkerrhat_p2prm_p2 = S1_p2prm_p2*Skerrhat1 + S2_p2prm_p2*Skerrhat2 + S3_p2prm_p2*Skerrhat3
    Sdotn_p2prm_p2 = S1_p2prm_p2*n1 + S2_p2prm_p2*n2 + S3_p2prm_p2*n3
    Sdotv_p2prm_p2 = S1_p2prm_p2*v1 + S2_p2prm_p2*v2 + S3_p2prm_p2*v3
    Sdotxi_p2prm_p2 = S1_p2prm_p2*xi1 + S2_p2prm_p2*xi2 + S3_p2prm_p2*xi3
    SdotSkerr_p2prm_p2 = S1_p2prm_p2*Skerr1 + S2_p2prm_p2*Skerr2 + S3_p2prm_p2*Skerr3
    HdsumTerm2_p2prm_p2 = 6*Sstardotn*Sstardotn_p2prm_p2 + 6*Sstardotn_p2*Sstardotnprm_p2
    HdsumTerm1_p2prm_p2 = 2*Sstar1*Sstar1_p2prm_p2 + 2*Sstar1_p2*Sstar1prm_p2 + 2*Sstar2*Sstar2_p2prm_p2 + 2*Sstar2_p2*Sstar2prm_p2 + 2*Sstar3*Sstar3_p2prm_p2 + 2*Sstar3_p2*Sstar3prm_p2
    Hdsum_p2prm_p2 = HdsumTerm1_p2prm_p2 - HdsumTerm2_p2prm_p2
    Q4_p2prm_p2 = 24*eta*prT**2*prT_p2*prTprm_p2*u**2*(-3*eta + 4)
    gammappsum_p2prm_p2 = 2*Deltar*pdotn_p2*pdotnprm_p2/Sigma + 2*pdotvr_p2*pdotvrprm_p2/(Sigma*sin2theta) + 2*Sigma*pdotxir_p2*pdotxirprm_p2/(Lambt*sin2theta)
    Hnsradicand_p2prm_p2 = Q4_p2prm_p2 + gammappsum_p2prm_p2
    HssTerm3_p2prm_p2 = Btilde**2*(Sdotn*exp2mu*xisq*(-Q_p2prm_p2 - Q_p2prm_p2/(2*np.sqrt(Q)) + Q_p2*Qprm_p2/(4*Q**(3/2))) + Sdotn_p2*exp2mu*xisq*(-Qprm_p2 - Qprm_p2/(2*np.sqrt(Q))) + Sdotn_p2prm_p2*exp2mu*xisq*(-np.sqrt(Q) - Q) + Sdotnprm_p2*exp2mu*xisq*(-Q_p2 - Q_p2/(2*np.sqrt(Q))) + pdotvr*(-Jtilde*Sdotv_p2*pdotnprm_p2 - Jtilde*Sdotv_p2prm_p2*pdotn - Jtilde*Sdotvprm_p2*pdotn_p2 + Sdotn_p2*pdotvrprm_p2 + Sdotn_p2prm_p2*pdotvr + Sdotnprm_p2*pdotvr_p2) + pdotvr_p2*(-Jtilde*Sdotv*pdotnprm_p2 - Jtilde*Sdotvprm_p2*pdotn + Sdotn*pdotvrprm_p2 + Sdotnprm_p2*pdotvr) + pdotvrprm_p2*(-Jtilde*Sdotv*pdotn_p2 - Jtilde*Sdotv_p2*pdotn + Sdotn*pdotvr_p2 + Sdotn_p2*pdotvr)) + expmu*expnu*pdotxir*(Btilde*Jtilde*Sdotxi_p2*pdotnprm_p2 + Btilde*Jtilde*Sdotxi_p2prm_p2*pdotn + Btilde*Jtilde*Sdotxiprm_p2*pdotn_p2 - Sdotn_p2*expmu*expnu*pdotxirprm_p2 - Sdotn_p2prm_p2*expmu*expnu*pdotxir - Sdotnprm_p2*expmu*expnu*pdotxir_p2) + expmu*expnu*pdotxir_p2*(Btilde*Jtilde*Sdotxi*pdotnprm_p2 + Btilde*Jtilde*Sdotxiprm_p2*pdotn - Sdotn*expmu*expnu*pdotxirprm_p2 - Sdotnprm_p2*expmu*expnu*pdotxir) + expmu*expnu*pdotxirprm_p2*(Btilde*Jtilde*Sdotxi*pdotn_p2 + Btilde*Jtilde*Sdotxi_p2*pdotn - Sdotn*expmu*expnu*pdotxir_p2 - Sdotn_p2*expmu*expnu*pdotxir)
    HssTerm3coeff_p2prm_p2 = omegacostheta*(-Q_p2prm_p2 - Q_p2prm_p2/(2*np.sqrt(Q)) + Q_p2*Qprm_p2/(4*Q**(3/2)))/(2*Btilde*exp2mu*expmu*expnu*(np.sqrt(Q) + Q)**2) + omegacostheta*(-Q_p2 - Q_p2/(2*np.sqrt(Q)))*(-2*Qprm_p2 - Qprm_p2/np.sqrt(Q))/(2*Btilde*exp2mu*expmu*expnu*(np.sqrt(Q) + Q)**3)
    HssTerm2_p2prm_p2 = Btilde**2*xisq*(Jtilde*pdotn*(-Jtilde*Sdotv_p2*pdotnprm_p2 - Jtilde*Sdotv_p2prm_p2*pdotn - Jtilde*Sdotvprm_p2*pdotn_p2 + Sdotn_p2*pdotvrprm_p2 + Sdotn_p2prm_p2*pdotvr + Sdotnprm_p2*pdotvr_p2) + Jtilde*pdotn_p2*(-Jtilde*Sdotv*pdotnprm_p2 - Jtilde*Sdotvprm_p2*pdotn + Sdotn*pdotvrprm_p2 + Sdotnprm_p2*pdotvr) + Jtilde*pdotnprm_p2*(-Jtilde*Sdotv*pdotn_p2 - Jtilde*Sdotv_p2*pdotn + Sdotn*pdotvr_p2 + Sdotn_p2*pdotvr) + Sdotv*exp2mu*(Q_p2prm_p2 + Q_p2prm_p2/(2*np.sqrt(Q)) - Q_p2*Qprm_p2/(4*Q**(3/2))) + Sdotv_p2*exp2mu*(Qprm_p2 + Qprm_p2/(2*np.sqrt(Q))) + Sdotv_p2prm_p2*exp2mu*(np.sqrt(Q) + Q) + Sdotvprm_p2*exp2mu*(Q_p2 + Q_p2/(2*np.sqrt(Q)))) + expmu*pdotxir*(-Btilde*Sdotxi_p2*expnu*pdotvrprm_p2 - Btilde*Sdotxi_p2prm_p2*expnu*pdotvr - Btilde*Sdotxiprm_p2*expnu*pdotvr_p2 + Sdotv_p2*exp2nu*expmu*pdotxirprm_p2 + Sdotv_p2prm_p2*exp2nu*expmu*pdotxir + Sdotvprm_p2*exp2nu*expmu*pdotxir_p2) + expmu*pdotxir_p2*(-Btilde*Sdotxi*expnu*pdotvrprm_p2 - Btilde*Sdotxiprm_p2*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxirprm_p2 + Sdotvprm_p2*exp2nu*expmu*pdotxir) + expmu*pdotxirprm_p2*(-Btilde*Sdotxi*expnu*pdotvr_p2 - Btilde*Sdotxi_p2*expnu*pdotvr + Sdotv*exp2nu*expmu*pdotxir_p2 + Sdotv_p2*exp2nu*expmu*pdotxir)
    HssTerm2coeff_p2prm_p2 = Jtilde*omegar*(-Q_p2prm_p2 - Q_p2prm_p2/(2*np.sqrt(Q)) + Q_p2*Qprm_p2/(4*Q**(3/2)))/(2*Btilde*exp2mu*expmu*expnu*xisq*(np.sqrt(Q) + Q)**2) + Jtilde*omegar*(-Q_p2 - Q_p2/(2*np.sqrt(Q)))*(-2*Qprm_p2 - Qprm_p2/np.sqrt(Q))/(2*Btilde*exp2mu*expmu*expnu*xisq*(np.sqrt(Q) + Q)**3)
    HssTerm1_p2prm_p2 = SdotSkerrhat_p2prm_p2*omega
    Hss_p2prm_p2 = HssTerm1_p2prm_p2 + HssTerm2*HssTerm2coeff_p2prm_p2 + HssTerm2_p2*HssTerm2coeffprm_p2 + HssTerm2_p2prm_p2*HssTerm2coeff + HssTerm2coeff_p2*HssTerm2prm_p2 + HssTerm3*HssTerm3coeff_p2prm_p2 + HssTerm3_p2*HssTerm3coeffprm_p2 + HssTerm3_p2prm_p2*HssTerm3coeff + HssTerm3coeff_p2*HssTerm3prm_p2
    HsoTerm2c_p2prm_p2 = Brtilde*Jtilde*Sdotv_p2*expmu*expnu*pdotxirprm_p2*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotv_p2prm_p2*expmu*expnu*pdotxir*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Sdotvprm_p2*expmu*expnu*pdotxir_p2*(np.sqrt(Q) + 1) + Brtilde*Jtilde*Q_p2*Sdotv*expmu*expnu*pdotxirprm_p2/(2*np.sqrt(Q)) + Brtilde*Jtilde*Q_p2*Sdotvprm_p2*expmu*expnu*pdotxir/(2*np.sqrt(Q)) + Brtilde*Jtilde*Q_p2prm_p2*Sdotv*expmu*expnu*pdotxir/(2*np.sqrt(Q)) + Brtilde*Jtilde*Qprm_p2*Sdotv*expmu*expnu*pdotxir_p2/(2*np.sqrt(Q)) + Brtilde*Jtilde*Qprm_p2*Sdotv_p2*expmu*expnu*pdotxir/(2*np.sqrt(Q)) - Brtilde*Jtilde*Q_p2*Qprm_p2*Sdotv*expmu*expnu*pdotxir/(4*Q**(3/2))
    HsoTerm2b_p2prm_p2 = Btilde*expmu*expnu*pdotxir*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv_p2prm_p2*nur - Sdotn_p2prm_p2*nucostheta*xisq) + Btilde*expmu*expnu*pdotxir_p2*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotvprm_p2*nur - Sdotnprm_p2*nucostheta*xisq) + Btilde*expmu*expnu*pdotxirprm_p2*(2*np.sqrt(Q) + 1)*(Jtilde*Sdotv_p2*nur - Sdotn_p2*nucostheta*xisq) + Btilde*Q_p2*expmu*expnu*pdotxir*(Jtilde*Sdotvprm_p2*nur - Sdotnprm_p2*nucostheta*xisq)/np.sqrt(Q) + Btilde*Q_p2*expmu*expnu*pdotxirprm_p2*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) + Btilde*Q_p2prm_p2*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) + Btilde*Qprm_p2*expmu*expnu*pdotxir*(Jtilde*Sdotv_p2*nur - Sdotn_p2*nucostheta*xisq)/np.sqrt(Q) + Btilde*Qprm_p2*expmu*expnu*pdotxir_p2*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/np.sqrt(Q) - Btilde*Q_p2*Qprm_p2*expmu*expnu*pdotxir*(Jtilde*Sdotv*nur - Sdotn*nucostheta*xisq)/(2*Q**(3/2))
    HsoTerm2a_p2prm_p2 = Btilde**2*Jtilde*Sdotxi*(Q_p2*mur*pdotvrprm_p2/(2*np.sqrt(Q)) + Q_p2*(-nur*pdotvrprm_p2 + pdotnprm_p2*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q)) + Q_p2prm_p2*mur*pdotvr/(2*np.sqrt(Q)) + Q_p2prm_p2*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q)) + Qprm_p2*mur*pdotvr_p2/(2*np.sqrt(Q)) - Qprm_p2*(nur*pdotvr_p2 + pdotn_p2*xisq*(mucostheta - nucostheta))/(2*np.sqrt(Q)) - Q_p2*Qprm_p2*mur*pdotvr/(4*Q**(3/2)) - Q_p2*Qprm_p2*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(4*Q**(3/2))) + Btilde**2*Jtilde*Sdotxi_p2*(np.sqrt(Q)*(-nur*pdotvrprm_p2 + pdotnprm_p2*xisq*(-mucostheta + nucostheta)) - mucostheta*pdotnprm_p2*xisq + mur*pdotvrprm_p2*(np.sqrt(Q) + 1) + Qprm_p2*mur*pdotvr/(2*np.sqrt(Q)) + Qprm_p2*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q))) + Btilde**2*Jtilde*Sdotxi_p2prm_p2*(np.sqrt(Q)*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta)) - mucostheta*pdotn*xisq + mur*pdotvr*(np.sqrt(Q) + 1)) + Btilde**2*Jtilde*Sdotxiprm_p2*(-np.sqrt(Q)*(nur*pdotvr_p2 + pdotn_p2*xisq*(mucostheta - nucostheta)) - mucostheta*pdotn_p2*xisq + mur*pdotvr_p2*(np.sqrt(Q) + 1) + Q_p2*mur*pdotvr/(2*np.sqrt(Q)) + Q_p2*(-nur*pdotvr + pdotn*xisq*(-mucostheta + nucostheta))/(2*np.sqrt(Q)))
    HsoTerm2_p2prm_p2 = HsoTerm2a_p2prm_p2 + HsoTerm2b_p2prm_p2 - HsoTerm2c_p2prm_p2
    HsoTerm2coeff_p2prm_p2 = expnu*(-Q_p2prm_p2 - Q_p2prm_p2/(2*np.sqrt(Q)) + Q_p2*Qprm_p2/(4*Q**(3/2)))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**2) + expnu*(-Q_p2 - Q_p2/(2*np.sqrt(Q)))*(-2*Qprm_p2 - Qprm_p2/np.sqrt(Q))/(Btilde**2*exp2mu*xisq*(np.sqrt(Q) + Q)**3)
    HsoTerm1_p2prm_p2 = SdotSkerrhat_p2*exp2nu*pdotxirprm_p2*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhat_p2prm_p2*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) + SdotSkerrhatprm_p2*exp2nu*pdotxir_p2*(-Btilde + expmu*expnu)/(Btilde**2*np.sqrt(Q)*expmu*xisq) - Q_p2*SdotSkerrhat*exp2nu*pdotxirprm_p2*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Q_p2*SdotSkerrhatprm_p2*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Q_p2prm_p2*SdotSkerrhat*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Qprm_p2*SdotSkerrhat*exp2nu*pdotxir_p2*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) - Qprm_p2*SdotSkerrhat_p2*exp2nu*pdotxir*(-Btilde + expmu*expnu)/(2*Btilde**2*Q**(3/2)*expmu*xisq) + Q_p2*Qprm_p2*SdotSkerrhat*exp2nu*pdotxir*(-3*Btilde + 3*expmu*expnu)/(4*Btilde**2*Q**(5/2)*expmu*xisq)
    Hso_p2prm_p2 = HsoTerm1_p2prm_p2 + HsoTerm2*HsoTerm2coeff_p2prm_p2 + HsoTerm2_p2*HsoTerm2coeffprm_p2 + HsoTerm2_p2prm_p2*HsoTerm2coeff + HsoTerm2coeff_p2*HsoTerm2prm_p2
    Hd_p2prm_p2 = Hdcoeff*Hdsum_p2prm_p2
    Hns_p2prm_p2 = Hnsradicand_p2prm_p2*alpha/(2*np.sqrt(Hnsradicand)) - Hnsradicand_p2*Hnsradicandprm_p2*alpha/(4*Hnsradicand**(3/2))
    Hs_p2prm_p2 = Hso_p2prm_p2 + Hss_p2prm_p2
    Heff_p2prm_p2 = -Hd_p2prm_p2 + Hns_p2prm_p2 + Hs_p2prm_p2
    Hreal_p2prm_p2 = -Heff_p2*Heffprm_p2*eta**2/(2*eta*(Heff - 1) + 1)**(3/2) + Heff_p2prm_p2*eta/np.sqrt(2*eta*(Heff - 1) + 1)
    return np.array([Hreal_p2prm_p2])