...
def output_H_sec_derivs():
    ...
    f = open("SEOBNR_Sph_Playground_Pycodes/dHdr.txt", 'r')
...
#        outsprhs.append(rhss_deriv_x[i])
    ...
    with open("SEOBNR_Sph_Playground_Pycodes/d2Hdr2.py", "w") as file:
...
""")
        ...
        file.write("    return np.array([Hreal_rprm_r])")    

    with open("SEOBNR_Sph_Playground_Pycodes/d2Hdrdpphi.py", "w") as file:
        file.write("""from __future__ import division
import numpy as np
...
""")
    ...
    f = open("SEOBNR_Sph_Playground_Pycodes/dHdpphi.txt", 'r')
    Hamstring = str(f.read())
    f.close()
...
#        outsprhs.append(rhss_deriv_x[i])
#
    with open("SEOBNR_Sph_Playground_Pycodes/d2Hdpphidr.py", "w") as file:
        file.write("""from __future__ import division
import numpy as np
